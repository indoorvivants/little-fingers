...
object aliases:
  ...
  */
  ...
  object LoadFileDataCallback: 
    ...
    inline def fromPtr(ptr: Ptr[Byte]): LoadFileDataCallback = CFuncPtr.fromPtr(ptr)
  ...
  */
  ...
  object LoadFileTextCallback: 
    ...
    inline def fromPtr(ptr: Ptr[Byte]): LoadFileTextCallback = CFuncPtr.fromPtr(ptr)
  ...
  */
  ...
  object SaveFileDataCallback: 
    ...
    inline def fromPtr(ptr: Ptr[Byte]): SaveFileDataCallback = CFuncPtr.fromPtr(ptr)
  ...
  */
  ...
  object SaveFileTextCallback: 
    ...
    inline def fromPtr(ptr: Ptr[Byte]): SaveFileTextCallback = CFuncPtr.fromPtr(ptr)
...
private[raylib] object extern_functions:
  ...
  */
   ...
   * [bindgen] header: ./raylib/src/raymath.h
  */
  def Remap(value : Float, inputStart : Float, inputEnd : Float, outputStart : Float, outputEnd : Float): Float = extern
  ...
  */
  ...
  private[raylib] def __sn_wrap_raylib_AttachAudioStreamProcessor(stream : Ptr[AudioStream], processor : AudioCallback): Unit = extern

  private[raylib] def __sn_wrap_raylib_BeginMode2D(camera : Ptr[Camera2D]): Unit = extern

  private[raylib] def __sn_wrap_raylib_BeginMode3D(camera : Ptr[Camera3D]): Unit = extern

  private[raylib] def __sn_wrap_raylib_BeginShaderMode(shader : Ptr[Shader]): Unit = extern

  private[raylib] def __sn_wrap_raylib_BeginTextureMode(target : Ptr[RenderTexture2D]): Unit = extern

  private[raylib] def __sn_wrap_raylib_BeginVrStereoMode(config : Ptr[VrStereoConfig]): Unit = extern

  private[raylib] def __sn_wrap_raylib_CheckCollisionBoxSphere(box : Ptr[BoundingBox], center : Ptr[Vector3], radius : Float): Boolean = extern

  private[raylib] def __sn_wrap_raylib_CheckCollisionBoxes(box1 : Ptr[BoundingBox], box2 : Ptr[BoundingBox]): Boolean = extern

  private[raylib] def __sn_wrap_raylib_CheckCollisionCircleRec(center : Ptr[Vector2], radius : Float, rec : Ptr[Rectangle]): Boolean = extern

  private[raylib] def __sn_wrap_raylib_CheckCollisionCircles(center1 : Ptr[Vector2], radius1 : Float, center2 : Ptr[Vector2], radius2 : Float): Boolean = extern

  private[raylib] def __sn_wrap_raylib_CheckCollisionLines(startPos1 : Ptr[Vector2], endPos1 : Ptr[Vector2], startPos2 : Ptr[Vector2], endPos2 : Ptr[Vector2], collisionPoint : Ptr[Vector2]): Boolean = extern

  private[raylib] def __sn_wrap_raylib_CheckCollisionPointCircle(point : Ptr[Vector2], center : Ptr[Vector2], radius : Float): Boolean = extern

  private[raylib] def __sn_wrap_raylib_CheckCollisionPointLine(point : Ptr[Vector2], p1 : Ptr[Vector2], p2 : Ptr[Vector2], threshold : CInt): Boolean = extern

  private[raylib] def __sn_wrap_raylib_CheckCollisionPointPoly(point : Ptr[Vector2], points : Ptr[Vector2], pointCount : CInt): Boolean = extern

  private[raylib] def __sn_wrap_raylib_CheckCollisionPointRec(point : Ptr[Vector2], rec : Ptr[Rectangle]): Boolean = extern

  private[raylib] def __sn_wrap_raylib_CheckCollisionPointTriangle(point : Ptr[Vector2], p1 : Ptr[Vector2], p2 : Ptr[Vector2], p3 : Ptr[Vector2]): Boolean = extern

  private[raylib] def __sn_wrap_raylib_CheckCollisionRecs(rec1 : Ptr[Rectangle], rec2 : Ptr[Rectangle]): Boolean = extern

  private[raylib] def __sn_wrap_raylib_CheckCollisionSpheres(center1 : Ptr[Vector3], radius1 : Float, center2 : Ptr[Vector3], radius2 : Float): Boolean = extern

  private[raylib] def __sn_wrap_raylib_ClearBackground(color : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_ColorAlpha(color : Ptr[Color], alpha : Float, __return : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_ColorAlphaBlend(dst : Ptr[Color], src : Ptr[Color], tint : Ptr[Color], __return : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_ColorBrightness(color : Ptr[Color], factor : Float, __return : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_ColorContrast(color : Ptr[Color], contrast : Float, __return : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_ColorFromHSV(hue : Float, saturation : Float, value : Float, __return : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_ColorFromNormalized(normalized : Ptr[Vector4], __return : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_ColorNormalize(color : Ptr[Color], __return : Ptr[Vector4]): Unit = extern

  private[raylib] def __sn_wrap_raylib_ColorTint(color : Ptr[Color], tint : Ptr[Color], __return : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_ColorToHSV(color : Ptr[Color], __return : Ptr[Vector3]): Unit = extern

  private[raylib] def __sn_wrap_raylib_ColorToInt(color : Ptr[Color]): CInt = extern

  private[raylib] def __sn_wrap_raylib_DetachAudioStreamProcessor(stream : Ptr[AudioStream], processor : AudioCallback): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawBillboard(camera : Ptr[Camera], texture : Ptr[Texture2D], position : Ptr[Vector3], size : Float, tint : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawBillboardPro(camera : Ptr[Camera], texture : Ptr[Texture2D], source : Ptr[Rectangle], position : Ptr[Vector3], up : Ptr[Vector3], size : Ptr[Vector2], origin : Ptr[Vector2], rotation : Float, tint : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawBillboardRec(camera : Ptr[Camera], texture : Ptr[Texture2D], source : Ptr[Rectangle], position : Ptr[Vector3], size : Ptr[Vector2], tint : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawBoundingBox(box : Ptr[BoundingBox], color : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawCapsule(startPos : Ptr[Vector3], endPos : Ptr[Vector3], radius : Float, slices : CInt, rings : CInt, color : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawCapsuleWires(startPos : Ptr[Vector3], endPos : Ptr[Vector3], radius : Float, slices : CInt, rings : CInt, color : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawCircle(centerX : CInt, centerY : CInt, radius : Float, color : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawCircle3D(center : Ptr[Vector3], radius : Float, rotationAxis : Ptr[Vector3], rotationAngle : Float, color : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawCircleGradient(centerX : CInt, centerY : CInt, radius : Float, color1 : Ptr[Color], color2 : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawCircleLines(centerX : CInt, centerY : CInt, radius : Float, color : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawCircleLinesV(center : Ptr[Vector2], radius : Float, color : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawCircleSector(center : Ptr[Vector2], radius : Float, startAngle : Float, endAngle : Float, segments : CInt, color : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawCircleSectorLines(center : Ptr[Vector2], radius : Float, startAngle : Float, endAngle : Float, segments : CInt, color : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawCircleV(center : Ptr[Vector2], radius : Float, color : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawCube(position : Ptr[Vector3], width : Float, height : Float, length : Float, color : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawCubeV(position : Ptr[Vector3], size : Ptr[Vector3], color : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawCubeWires(position : Ptr[Vector3], width : Float, height : Float, length : Float, color : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawCubeWiresV(position : Ptr[Vector3], size : Ptr[Vector3], color : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawCylinder(position : Ptr[Vector3], radiusTop : Float, radiusBottom : Float, height : Float, slices : CInt, color : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawCylinderEx(startPos : Ptr[Vector3], endPos : Ptr[Vector3], startRadius : Float, endRadius : Float, sides : CInt, color : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawCylinderWires(position : Ptr[Vector3], radiusTop : Float, radiusBottom : Float, height : Float, slices : CInt, color : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawCylinderWiresEx(startPos : Ptr[Vector3], endPos : Ptr[Vector3], startRadius : Float, endRadius : Float, sides : CInt, color : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawEllipse(centerX : CInt, centerY : CInt, radiusH : Float, radiusV : Float, color : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawEllipseLines(centerX : CInt, centerY : CInt, radiusH : Float, radiusV : Float, color : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawLine(startPosX : CInt, startPosY : CInt, endPosX : CInt, endPosY : CInt, color : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawLine3D(startPos : Ptr[Vector3], endPos : Ptr[Vector3], color : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawLineBezier(startPos : Ptr[Vector2], endPos : Ptr[Vector2], thick : Float, color : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawLineEx(startPos : Ptr[Vector2], endPos : Ptr[Vector2], thick : Float, color : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawLineStrip(points : Ptr[Vector2], pointCount : CInt, color : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawLineV(startPos : Ptr[Vector2], endPos : Ptr[Vector2], color : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawMesh(mesh : Ptr[Mesh], material : Ptr[Material], transform : Ptr[Matrix]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawMeshInstanced(mesh : Ptr[Mesh], material : Ptr[Material], transforms : Ptr[Matrix], instances : CInt): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawModel(model : Ptr[Model], position : Ptr[Vector3], scale : Float, tint : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawModelEx(model : Ptr[Model], position : Ptr[Vector3], rotationAxis : Ptr[Vector3], rotationAngle : Float, scale : Ptr[Vector3], tint : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawModelWires(model : Ptr[Model], position : Ptr[Vector3], scale : Float, tint : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawModelWiresEx(model : Ptr[Model], position : Ptr[Vector3], rotationAxis : Ptr[Vector3], rotationAngle : Float, scale : Ptr[Vector3], tint : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawPixel(posX : CInt, posY : CInt, color : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawPixelV(position : Ptr[Vector2], color : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawPlane(centerPos : Ptr[Vector3], size : Ptr[Vector2], color : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawPoint3D(position : Ptr[Vector3], color : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawPoly(center : Ptr[Vector2], sides : CInt, radius : Float, rotation : Float, color : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawPolyLines(center : Ptr[Vector2], sides : CInt, radius : Float, rotation : Float, color : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawPolyLinesEx(center : Ptr[Vector2], sides : CInt, radius : Float, rotation : Float, lineThick : Float, color : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawRay(ray : Ptr[Ray], color : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawRectangle(posX : CInt, posY : CInt, width : CInt, height : CInt, color : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawRectangleGradientEx(rec : Ptr[Rectangle], col1 : Ptr[Color], col2 : Ptr[Color], col3 : Ptr[Color], col4 : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawRectangleGradientH(posX : CInt, posY : CInt, width : CInt, height : CInt, color1 : Ptr[Color], color2 : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawRectangleGradientV(posX : CInt, posY : CInt, width : CInt, height : CInt, color1 : Ptr[Color], color2 : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawRectangleLines(posX : CInt, posY : CInt, width : CInt, height : CInt, color : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawRectangleLinesEx(rec : Ptr[Rectangle], lineThick : Float, color : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawRectanglePro(rec : Ptr[Rectangle], origin : Ptr[Vector2], rotation : Float, color : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawRectangleRec(rec : Ptr[Rectangle], color : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawRectangleRounded(rec : Ptr[Rectangle], roundness : Float, segments : CInt, color : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawRectangleRoundedLines(rec : Ptr[Rectangle], roundness : Float, segments : CInt, lineThick : Float, color : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawRectangleV(position : Ptr[Vector2], size : Ptr[Vector2], color : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawRing(center : Ptr[Vector2], innerRadius : Float, outerRadius : Float, startAngle : Float, endAngle : Float, segments : CInt, color : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawRingLines(center : Ptr[Vector2], innerRadius : Float, outerRadius : Float, startAngle : Float, endAngle : Float, segments : CInt, color : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawSphere(centerPos : Ptr[Vector3], radius : Float, color : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawSphereEx(centerPos : Ptr[Vector3], radius : Float, rings : CInt, slices : CInt, color : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawSphereWires(centerPos : Ptr[Vector3], radius : Float, rings : CInt, slices : CInt, color : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawSplineBasis(points : Ptr[Vector2], pointCount : CInt, thick : Float, color : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawSplineBezierCubic(points : Ptr[Vector2], pointCount : CInt, thick : Float, color : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawSplineBezierQuadratic(points : Ptr[Vector2], pointCount : CInt, thick : Float, color : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawSplineCatmullRom(points : Ptr[Vector2], pointCount : CInt, thick : Float, color : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawSplineLinear(points : Ptr[Vector2], pointCount : CInt, thick : Float, color : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawSplineSegmentBasis(p1 : Ptr[Vector2], p2 : Ptr[Vector2], p3 : Ptr[Vector2], p4 : Ptr[Vector2], thick : Float, color : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawSplineSegmentBezierCubic(p1 : Ptr[Vector2], c2 : Ptr[Vector2], c3 : Ptr[Vector2], p4 : Ptr[Vector2], thick : Float, color : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawSplineSegmentBezierQuadratic(p1 : Ptr[Vector2], c2 : Ptr[Vector2], p3 : Ptr[Vector2], thick : Float, color : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawSplineSegmentCatmullRom(p1 : Ptr[Vector2], p2 : Ptr[Vector2], p3 : Ptr[Vector2], p4 : Ptr[Vector2], thick : Float, color : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawSplineSegmentLinear(p1 : Ptr[Vector2], p2 : Ptr[Vector2], thick : Float, color : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawText(text : CString, posX : CInt, posY : CInt, fontSize : CInt, color : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawTextCodepoint(font : Ptr[Font], codepoint : CInt, position : Ptr[Vector2], fontSize : Float, tint : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawTextCodepoints(font : Ptr[Font], codepoints : Ptr[CInt], codepointCount : CInt, position : Ptr[Vector2], fontSize : Float, spacing : Float, tint : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawTextEx(font : Ptr[Font], text : CString, position : Ptr[Vector2], fontSize : Float, spacing : Float, tint : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawTextPro(font : Ptr[Font], text : CString, position : Ptr[Vector2], origin : Ptr[Vector2], rotation : Float, fontSize : Float, spacing : Float, tint : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawTexture(texture : Ptr[Texture2D], posX : CInt, posY : CInt, tint : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawTextureEx(texture : Ptr[Texture2D], position : Ptr[Vector2], rotation : Float, scale : Float, tint : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawTextureNPatch(texture : Ptr[Texture2D], nPatchInfo : Ptr[NPatchInfo], dest : Ptr[Rectangle], origin : Ptr[Vector2], rotation : Float, tint : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawTexturePro(texture : Ptr[Texture2D], source : Ptr[Rectangle], dest : Ptr[Rectangle], origin : Ptr[Vector2], rotation : Float, tint : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawTextureRec(texture : Ptr[Texture2D], source : Ptr[Rectangle], position : Ptr[Vector2], tint : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawTextureV(texture : Ptr[Texture2D], position : Ptr[Vector2], tint : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawTriangle(v1 : Ptr[Vector2], v2 : Ptr[Vector2], v3 : Ptr[Vector2], color : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawTriangle3D(v1 : Ptr[Vector3], v2 : Ptr[Vector3], v3 : Ptr[Vector3], color : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawTriangleFan(points : Ptr[Vector2], pointCount : CInt, color : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawTriangleLines(v1 : Ptr[Vector2], v2 : Ptr[Vector2], v3 : Ptr[Vector2], color : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawTriangleStrip(points : Ptr[Vector2], pointCount : CInt, color : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_DrawTriangleStrip3D(points : Ptr[Vector3], pointCount : CInt, color : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_ExportAutomationEventList(list : Ptr[AutomationEventList], fileName : CString): Boolean = extern

  private[raylib] def __sn_wrap_raylib_ExportFontAsCode(font : Ptr[Font], fileName : CString): Boolean = extern

  private[raylib] def __sn_wrap_raylib_ExportImage(image : Ptr[Image], fileName : CString): Boolean = extern

  private[raylib] def __sn_wrap_raylib_ExportImageAsCode(image : Ptr[Image], fileName : CString): Boolean = extern

  private[raylib] def __sn_wrap_raylib_ExportImageToMemory(image : Ptr[Image], fileType : CString, fileSize : Ptr[CInt]): Ptr[CUnsignedChar] = extern

  private[raylib] def __sn_wrap_raylib_ExportMesh(mesh : Ptr[Mesh], fileName : CString): Boolean = extern

  private[raylib] def __sn_wrap_raylib_ExportWave(wave : Ptr[Wave], fileName : CString): Boolean = extern

  private[raylib] def __sn_wrap_raylib_ExportWaveAsCode(wave : Ptr[Wave], fileName : CString): Boolean = extern

  private[raylib] def __sn_wrap_raylib_Fade(color : Ptr[Color], alpha : Float, __return : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_GenImageCellular(width : CInt, height : CInt, tileSize : CInt, __return : Ptr[Image]): Unit = extern

  private[raylib] def __sn_wrap_raylib_GenImageChecked(width : CInt, height : CInt, checksX : CInt, checksY : CInt, col1 : Ptr[Color], col2 : Ptr[Color], __return : Ptr[Image]): Unit = extern

  private[raylib] def __sn_wrap_raylib_GenImageColor(width : CInt, height : CInt, color : Ptr[Color], __return : Ptr[Image]): Unit = extern

  private[raylib] def __sn_wrap_raylib_GenImageFontAtlas(glyphs : Ptr[GlyphInfo], glyphRecs : Ptr[Ptr[Rectangle]], glyphCount : CInt, fontSize : CInt, padding : CInt, packMethod : CInt, __return : Ptr[Image]): Unit = extern

  private[raylib] def __sn_wrap_raylib_GenImageGradientLinear(width : CInt, height : CInt, direction : CInt, start : Ptr[Color], end : Ptr[Color], __return : Ptr[Image]): Unit = extern

  private[raylib] def __sn_wrap_raylib_GenImageGradientRadial(width : CInt, height : CInt, density : Float, inner : Ptr[Color], outer : Ptr[Color], __return : Ptr[Image]): Unit = extern

  private[raylib] def __sn_wrap_raylib_GenImageGradientSquare(width : CInt, height : CInt, density : Float, inner : Ptr[Color], outer : Ptr[Color], __return : Ptr[Image]): Unit = extern

  private[raylib] def __sn_wrap_raylib_GenImagePerlinNoise(width : CInt, height : CInt, offsetX : CInt, offsetY : CInt, scale : Float, __return : Ptr[Image]): Unit = extern

  private[raylib] def __sn_wrap_raylib_GenImageText(width : CInt, height : CInt, text : CString, __return : Ptr[Image]): Unit = extern

  private[raylib] def __sn_wrap_raylib_GenImageWhiteNoise(width : CInt, height : CInt, factor : Float, __return : Ptr[Image]): Unit = extern

  private[raylib] def __sn_wrap_raylib_GenMeshCone(radius : Float, height : Float, slices : CInt, __return : Ptr[Mesh]): Unit = extern

  private[raylib] def __sn_wrap_raylib_GenMeshCube(width : Float, height : Float, length : Float, __return : Ptr[Mesh]): Unit = extern

  private[raylib] def __sn_wrap_raylib_GenMeshCubicmap(cubicmap : Ptr[Image], cubeSize : Ptr[Vector3], __return : Ptr[Mesh]): Unit = extern

  private[raylib] def __sn_wrap_raylib_GenMeshCylinder(radius : Float, height : Float, slices : CInt, __return : Ptr[Mesh]): Unit = extern

  private[raylib] def __sn_wrap_raylib_GenMeshHeightmap(heightmap : Ptr[Image], size : Ptr[Vector3], __return : Ptr[Mesh]): Unit = extern

  private[raylib] def __sn_wrap_raylib_GenMeshHemiSphere(radius : Float, rings : CInt, slices : CInt, __return : Ptr[Mesh]): Unit = extern

  private[raylib] def __sn_wrap_raylib_GenMeshKnot(radius : Float, size : Float, radSeg : CInt, sides : CInt, __return : Ptr[Mesh]): Unit = extern

  private[raylib] def __sn_wrap_raylib_GenMeshPlane(width : Float, length : Float, resX : CInt, resZ : CInt, __return : Ptr[Mesh]): Unit = extern

  private[raylib] def __sn_wrap_raylib_GenMeshPoly(sides : CInt, radius : Float, __return : Ptr[Mesh]): Unit = extern

  private[raylib] def __sn_wrap_raylib_GenMeshSphere(radius : Float, rings : CInt, slices : CInt, __return : Ptr[Mesh]): Unit = extern

  private[raylib] def __sn_wrap_raylib_GenMeshTorus(radius : Float, size : Float, radSeg : CInt, sides : CInt, __return : Ptr[Mesh]): Unit = extern

  private[raylib] def __sn_wrap_raylib_GetCameraMatrix(camera : Ptr[Camera], __return : Ptr[Matrix]): Unit = extern

  private[raylib] def __sn_wrap_raylib_GetCameraMatrix2D(camera : Ptr[Camera2D], __return : Ptr[Matrix]): Unit = extern

  private[raylib] def __sn_wrap_raylib_GetCollisionRec(rec1 : Ptr[Rectangle], rec2 : Ptr[Rectangle], __return : Ptr[Rectangle]): Unit = extern

  private[raylib] def __sn_wrap_raylib_GetColor(hexValue : CUnsignedInt, __return : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_GetFontDefault(__return : Ptr[Font]): Unit = extern

  private[raylib] def __sn_wrap_raylib_GetGestureDragVector(__return : Ptr[Vector2]): Unit = extern

  private[raylib] def __sn_wrap_raylib_GetGesturePinchVector(__return : Ptr[Vector2]): Unit = extern

  private[raylib] def __sn_wrap_raylib_GetGlyphAtlasRec(font : Ptr[Font], codepoint : CInt, __return : Ptr[Rectangle]): Unit = extern

  private[raylib] def __sn_wrap_raylib_GetGlyphIndex(font : Ptr[Font], codepoint : CInt): CInt = extern

  private[raylib] def __sn_wrap_raylib_GetGlyphInfo(font : Ptr[Font], codepoint : CInt, __return : Ptr[GlyphInfo]): Unit = extern

  private[raylib] def __sn_wrap_raylib_GetImageAlphaBorder(image : Ptr[Image], threshold : Float, __return : Ptr[Rectangle]): Unit = extern

  private[raylib] def __sn_wrap_raylib_GetImageColor(image : Ptr[Image], x : CInt, y : CInt, __return : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_GetMeshBoundingBox(mesh : Ptr[Mesh], __return : Ptr[BoundingBox]): Unit = extern

  private[raylib] def __sn_wrap_raylib_GetModelBoundingBox(model : Ptr[Model], __return : Ptr[BoundingBox]): Unit = extern

  private[raylib] def __sn_wrap_raylib_GetMonitorPosition(monitor : CInt, __return : Ptr[Vector2]): Unit = extern

  private[raylib] def __sn_wrap_raylib_GetMouseDelta(__return : Ptr[Vector2]): Unit = extern

  private[raylib] def __sn_wrap_raylib_GetMousePosition(__return : Ptr[Vector2]): Unit = extern

  private[raylib] def __sn_wrap_raylib_GetMouseRay(mousePosition : Ptr[Vector2], camera : Ptr[Camera], __return : Ptr[Ray]): Unit = extern

  private[raylib] def __sn_wrap_raylib_GetMouseWheelMoveV(__return : Ptr[Vector2]): Unit = extern

  private[raylib] def __sn_wrap_raylib_GetMusicTimeLength(music : Ptr[Music]): Float = extern

  private[raylib] def __sn_wrap_raylib_GetMusicTimePlayed(music : Ptr[Music]): Float = extern

  private[raylib] def __sn_wrap_raylib_GetPixelColor(srcPtr : Ptr[Byte], format : CInt, __return : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_GetRayCollisionBox(ray : Ptr[Ray], box : Ptr[BoundingBox], __return : Ptr[RayCollision]): Unit = extern

  private[raylib] def __sn_wrap_raylib_GetRayCollisionMesh(ray : Ptr[Ray], mesh : Ptr[Mesh], transform : Ptr[Matrix], __return : Ptr[RayCollision]): Unit = extern

  private[raylib] def __sn_wrap_raylib_GetRayCollisionQuad(ray : Ptr[Ray], p1 : Ptr[Vector3], p2 : Ptr[Vector3], p3 : Ptr[Vector3], p4 : Ptr[Vector3], __return : Ptr[RayCollision]): Unit = extern

  private[raylib] def __sn_wrap_raylib_GetRayCollisionSphere(ray : Ptr[Ray], center : Ptr[Vector3], radius : Float, __return : Ptr[RayCollision]): Unit = extern

  private[raylib] def __sn_wrap_raylib_GetRayCollisionTriangle(ray : Ptr[Ray], p1 : Ptr[Vector3], p2 : Ptr[Vector3], p3 : Ptr[Vector3], __return : Ptr[RayCollision]): Unit = extern

  private[raylib] def __sn_wrap_raylib_GetScreenToWorld2D(position : Ptr[Vector2], camera : Ptr[Camera2D], __return : Ptr[Vector2]): Unit = extern

  private[raylib] def __sn_wrap_raylib_GetShaderLocation(shader : Ptr[Shader], uniformName : CString): CInt = extern

  private[raylib] def __sn_wrap_raylib_GetShaderLocationAttrib(shader : Ptr[Shader], attribName : CString): CInt = extern

  private[raylib] def __sn_wrap_raylib_GetSplinePointBasis(p1 : Ptr[Vector2], p2 : Ptr[Vector2], p3 : Ptr[Vector2], p4 : Ptr[Vector2], t : Float, __return : Ptr[Vector2]): Unit = extern

  private[raylib] def __sn_wrap_raylib_GetSplinePointBezierCubic(p1 : Ptr[Vector2], c2 : Ptr[Vector2], c3 : Ptr[Vector2], p4 : Ptr[Vector2], t : Float, __return : Ptr[Vector2]): Unit = extern

  private[raylib] def __sn_wrap_raylib_GetSplinePointBezierQuad(p1 : Ptr[Vector2], c2 : Ptr[Vector2], p3 : Ptr[Vector2], t : Float, __return : Ptr[Vector2]): Unit = extern

  private[raylib] def __sn_wrap_raylib_GetSplinePointCatmullRom(p1 : Ptr[Vector2], p2 : Ptr[Vector2], p3 : Ptr[Vector2], p4 : Ptr[Vector2], t : Float, __return : Ptr[Vector2]): Unit = extern

  private[raylib] def __sn_wrap_raylib_GetSplinePointLinear(startPos : Ptr[Vector2], endPos : Ptr[Vector2], t : Float, __return : Ptr[Vector2]): Unit = extern

  private[raylib] def __sn_wrap_raylib_GetTouchPosition(index : CInt, __return : Ptr[Vector2]): Unit = extern

  private[raylib] def __sn_wrap_raylib_GetWindowPosition(__return : Ptr[Vector2]): Unit = extern

  private[raylib] def __sn_wrap_raylib_GetWindowScaleDPI(__return : Ptr[Vector2]): Unit = extern

  private[raylib] def __sn_wrap_raylib_GetWorldToScreen(position : Ptr[Vector3], camera : Ptr[Camera], __return : Ptr[Vector2]): Unit = extern

  private[raylib] def __sn_wrap_raylib_GetWorldToScreen2D(position : Ptr[Vector2], camera : Ptr[Camera2D], __return : Ptr[Vector2]): Unit = extern

  private[raylib] def __sn_wrap_raylib_GetWorldToScreenEx(position : Ptr[Vector3], camera : Ptr[Camera], width : CInt, height : CInt, __return : Ptr[Vector2]): Unit = extern

  private[raylib] def __sn_wrap_raylib_ImageAlphaClear(image : Ptr[Image], color : Ptr[Color], threshold : Float): Unit = extern

  private[raylib] def __sn_wrap_raylib_ImageAlphaMask(image : Ptr[Image], alphaMask : Ptr[Image]): Unit = extern

  private[raylib] def __sn_wrap_raylib_ImageClearBackground(dst : Ptr[Image], color : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_ImageColorReplace(image : Ptr[Image], color : Ptr[Color], replace : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_ImageColorTint(image : Ptr[Image], color : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_ImageCopy(image : Ptr[Image], __return : Ptr[Image]): Unit = extern

  private[raylib] def __sn_wrap_raylib_ImageCrop(image : Ptr[Image], crop : Ptr[Rectangle]): Unit = extern

  private[raylib] def __sn_wrap_raylib_ImageDraw(dst : Ptr[Image], src : Ptr[Image], srcRec : Ptr[Rectangle], dstRec : Ptr[Rectangle], tint : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_ImageDrawCircle(dst : Ptr[Image], centerX : CInt, centerY : CInt, radius : CInt, color : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_ImageDrawCircleLines(dst : Ptr[Image], centerX : CInt, centerY : CInt, radius : CInt, color : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_ImageDrawCircleLinesV(dst : Ptr[Image], center : Ptr[Vector2], radius : CInt, color : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_ImageDrawCircleV(dst : Ptr[Image], center : Ptr[Vector2], radius : CInt, color : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_ImageDrawLine(dst : Ptr[Image], startPosX : CInt, startPosY : CInt, endPosX : CInt, endPosY : CInt, color : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_ImageDrawLineV(dst : Ptr[Image], start : Ptr[Vector2], end : Ptr[Vector2], color : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_ImageDrawPixel(dst : Ptr[Image], posX : CInt, posY : CInt, color : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_ImageDrawPixelV(dst : Ptr[Image], position : Ptr[Vector2], color : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_ImageDrawRectangle(dst : Ptr[Image], posX : CInt, posY : CInt, width : CInt, height : CInt, color : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_ImageDrawRectangleLines(dst : Ptr[Image], rec : Ptr[Rectangle], thick : CInt, color : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_ImageDrawRectangleRec(dst : Ptr[Image], rec : Ptr[Rectangle], color : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_ImageDrawRectangleV(dst : Ptr[Image], position : Ptr[Vector2], size : Ptr[Vector2], color : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_ImageDrawText(dst : Ptr[Image], text : CString, posX : CInt, posY : CInt, fontSize : CInt, color : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_ImageDrawTextEx(dst : Ptr[Image], font : Ptr[Font], text : CString, position : Ptr[Vector2], fontSize : Float, spacing : Float, tint : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_ImageFromImage(image : Ptr[Image], rec : Ptr[Rectangle], __return : Ptr[Image]): Unit = extern

  private[raylib] def __sn_wrap_raylib_ImageResizeCanvas(image : Ptr[Image], newWidth : CInt, newHeight : CInt, offsetX : CInt, offsetY : CInt, fill : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_ImageText(text : CString, fontSize : CInt, color : Ptr[Color], __return : Ptr[Image]): Unit = extern

  private[raylib] def __sn_wrap_raylib_ImageTextEx(font : Ptr[Font], text : CString, fontSize : Float, spacing : Float, tint : Ptr[Color], __return : Ptr[Image]): Unit = extern

  private[raylib] def __sn_wrap_raylib_ImageToPOT(image : Ptr[Image], fill : Ptr[Color]): Unit = extern

  private[raylib] def __sn_wrap_raylib_IsAudioStreamPlaying(stream : Ptr[AudioStream]): Boolean = extern

  private[raylib] def __sn_wrap_raylib_IsAudioStreamProcessed(stream : Ptr[AudioStream]): Boolean = extern

  private[raylib] def __sn_wrap_raylib_IsAudioStreamReady(stream : Ptr[AudioStream]): Boolean = extern

  private[raylib] def __sn_wrap_raylib_IsFontReady(font : Ptr[Font]): Boolean = extern

  private[raylib] def __sn_wrap_raylib_IsImageReady(image : Ptr[Image]): Boolean = extern

  private[raylib] def __sn_wrap_raylib_IsMaterialReady(material : Ptr[Material]): Boolean = extern

  private[raylib] def __sn_wrap_raylib_IsModelAnimationValid(model : Ptr[Model], anim : Ptr[ModelAnimation]): Boolean = extern

  private[raylib] def __sn_wrap_raylib_IsModelReady(model : Ptr[Model]): Boolean = extern

  private[raylib] def __sn_wrap_raylib_IsMusicReady(music : Ptr[Music]): Boolean = extern

  private[raylib] def __sn_wrap_raylib_IsMusicStreamPlaying(music : Ptr[Music]): Boolean = extern

  private[raylib] def __sn_wrap_raylib_IsRenderTextureReady(target : Ptr[RenderTexture2D]): Boolean = extern

  private[raylib] def __sn_wrap_raylib_IsShaderReady(shader : Ptr[Shader]): Boolean = extern

  private[raylib] def __sn_wrap_raylib_IsSoundPlaying(sound : Ptr[Sound]): Boolean = extern

  private[raylib] def __sn_wrap_raylib_IsSoundReady(sound : Ptr[Sound]): Boolean = extern

  private[raylib] def __sn_wrap_raylib_IsTextureReady(texture : Ptr[Texture2D]): Boolean = extern

  private[raylib] def __sn_wrap_raylib_IsWaveReady(wave : Ptr[Wave]): Boolean = extern

  private[raylib] def __sn_wrap_raylib_LoadAudioStream(sampleRate : CUnsignedInt, sampleSize : CUnsignedInt, channels : CUnsignedInt, __return : Ptr[AudioStream]): Unit = extern

  private[raylib] def __sn_wrap_raylib_LoadAutomationEventList(fileName : CString, __return : Ptr[AutomationEventList]): Unit = extern

  private[raylib] def __sn_wrap_raylib_LoadDirectoryFiles(dirPath : CString, __return : Ptr[FilePathList]): Unit = extern

  private[raylib] def __sn_wrap_raylib_LoadDirectoryFilesEx(basePath : CString, filter : CString, scanSubdirs : Boolean, __return : Ptr[FilePathList]): Unit = extern

  private[raylib] def __sn_wrap_raylib_LoadDroppedFiles(__return : Ptr[FilePathList]): Unit = extern

  private[raylib] def __sn_wrap_raylib_LoadFont(fileName : CString, __return : Ptr[Font]): Unit = extern

  private[raylib] def __sn_wrap_raylib_LoadFontEx(fileName : CString, fontSize : CInt, codepoints : Ptr[CInt], codepointCount : CInt, __return : Ptr[Font]): Unit = extern

  private[raylib] def __sn_wrap_raylib_LoadFontFromImage(image : Ptr[Image], key : Ptr[Color], firstChar : CInt, __return : Ptr[Font]): Unit = extern

  private[raylib] def __sn_wrap_raylib_LoadFontFromMemory(fileType : CString, fileData : Ptr[CUnsignedChar], dataSize : CInt, fontSize : CInt, codepoints : Ptr[CInt], codepointCount : CInt, __return : Ptr[Font]): Unit = extern

  private[raylib] def __sn_wrap_raylib_LoadImage(fileName : CString, __return : Ptr[Image]): Unit = extern

  private[raylib] def __sn_wrap_raylib_LoadImageAnim(fileName : CString, frames : Ptr[CInt], __return : Ptr[Image]): Unit = extern

  private[raylib] def __sn_wrap_raylib_LoadImageColors(image : Ptr[Image]): Ptr[Color] = extern

  private[raylib] def __sn_wrap_raylib_LoadImageFromMemory(fileType : CString, fileData : Ptr[CUnsignedChar], dataSize : CInt, __return : Ptr[Image]): Unit = extern

  private[raylib] def __sn_wrap_raylib_LoadImageFromScreen(__return : Ptr[Image]): Unit = extern

  private[raylib] def __sn_wrap_raylib_LoadImageFromTexture(texture : Ptr[Texture2D], __return : Ptr[Image]): Unit = extern

  private[raylib] def __sn_wrap_raylib_LoadImagePalette(image : Ptr[Image], maxPaletteSize : CInt, colorCount : Ptr[CInt]): Ptr[Color] = extern

  private[raylib] def __sn_wrap_raylib_LoadImageRaw(fileName : CString, width : CInt, height : CInt, format : CInt, headerSize : CInt, __return : Ptr[Image]): Unit = extern

  private[raylib] def __sn_wrap_raylib_LoadImageSvg(fileNameOrString : CString, width : CInt, height : CInt, __return : Ptr[Image]): Unit = extern

  private[raylib] def __sn_wrap_raylib_LoadMaterialDefault(__return : Ptr[Material]): Unit = extern

  private[raylib] def __sn_wrap_raylib_LoadModel(fileName : CString, __return : Ptr[Model]): Unit = extern

  private[raylib] def __sn_wrap_raylib_LoadModelFromMesh(mesh : Ptr[Mesh], __return : Ptr[Model]): Unit = extern

  private[raylib] def __sn_wrap_raylib_LoadMusicStream(fileName : CString, __return : Ptr[Music]): Unit = extern

  private[raylib] def __sn_wrap_raylib_LoadMusicStreamFromMemory(fileType : CString, data : Ptr[CUnsignedChar], dataSize : CInt, __return : Ptr[Music]): Unit = extern

  private[raylib] def __sn_wrap_raylib_LoadRenderTexture(width : CInt, height : CInt, __return : Ptr[RenderTexture2D]): Unit = extern

  private[raylib] def __sn_wrap_raylib_LoadShader(vsFileName : CString, fsFileName : CString, __return : Ptr[Shader]): Unit = extern

  private[raylib] def __sn_wrap_raylib_LoadShaderFromMemory(vsCode : CString, fsCode : CString, __return : Ptr[Shader]): Unit = extern

  private[raylib] def __sn_wrap_raylib_LoadSound(fileName : CString, __return : Ptr[Sound]): Unit = extern

  private[raylib] def __sn_wrap_raylib_LoadSoundAlias(source : Ptr[Sound], __return : Ptr[Sound]): Unit = extern

  private[raylib] def __sn_wrap_raylib_LoadSoundFromWave(wave : Ptr[Wave], __return : Ptr[Sound]): Unit = extern

  private[raylib] def __sn_wrap_raylib_LoadTexture(fileName : CString, __return : Ptr[Texture2D]): Unit = extern

  private[raylib] def __sn_wrap_raylib_LoadTextureCubemap(image : Ptr[Image], layout : CInt, __return : Ptr[TextureCubemap]): Unit = extern

  private[raylib] def __sn_wrap_raylib_LoadTextureFromImage(image : Ptr[Image], __return : Ptr[Texture2D]): Unit = extern

  private[raylib] def __sn_wrap_raylib_LoadVrStereoConfig(device : Ptr[VrDeviceInfo], __return : Ptr[VrStereoConfig]): Unit = extern

  private[raylib] def __sn_wrap_raylib_LoadWave(fileName : CString, __return : Ptr[Wave]): Unit = extern

  private[raylib] def __sn_wrap_raylib_LoadWaveFromMemory(fileType : CString, fileData : Ptr[CUnsignedChar], dataSize : CInt, __return : Ptr[Wave]): Unit = extern

  private[raylib] def __sn_wrap_raylib_LoadWaveSamples(wave : Ptr[Wave]): Ptr[Float] = extern

  private[raylib] def __sn_wrap_raylib_MatrixAdd(left : Ptr[Matrix], right : Ptr[Matrix], __return : Ptr[Matrix]): Unit = extern

  private[raylib] def __sn_wrap_raylib_MatrixDeterminant(mat : Ptr[Matrix]): Float = extern

  private[raylib] def __sn_wrap_raylib_MatrixFrustum(left : Double, right : Double, bottom : Double, top : Double, near : Double, far : Double, __return : Ptr[Matrix]): Unit = extern

  private[raylib] def __sn_wrap_raylib_MatrixIdentity(__return : Ptr[Matrix]): Unit = extern

  private[raylib] def __sn_wrap_raylib_MatrixInvert(mat : Ptr[Matrix], __return : Ptr[Matrix]): Unit = extern

  private[raylib] def __sn_wrap_raylib_MatrixLookAt(eye : Ptr[Vector3], target : Ptr[Vector3], up : Ptr[Vector3], __return : Ptr[Matrix]): Unit = extern

  private[raylib] def __sn_wrap_raylib_MatrixMultiply(left : Ptr[Matrix], right : Ptr[Matrix], __return : Ptr[Matrix]): Unit = extern

  private[raylib] def __sn_wrap_raylib_MatrixOrtho(left : Double, right : Double, bottom : Double, top : Double, nearPlane : Double, farPlane : Double, __return : Ptr[Matrix]): Unit = extern

  private[raylib] def __sn_wrap_raylib_MatrixPerspective(fovY : Double, aspect : Double, nearPlane : Double, farPlane : Double, __return : Ptr[Matrix]): Unit = extern

  private[raylib] def __sn_wrap_raylib_MatrixRotate(axis : Ptr[Vector3], angle : Float, __return : Ptr[Matrix]): Unit = extern

  private[raylib] def __sn_wrap_raylib_MatrixRotateX(angle : Float, __return : Ptr[Matrix]): Unit = extern

  private[raylib] def __sn_wrap_raylib_MatrixRotateXYZ(angle : Ptr[Vector3], __return : Ptr[Matrix]): Unit = extern

  private[raylib] def __sn_wrap_raylib_MatrixRotateY(angle : Float, __return : Ptr[Matrix]): Unit = extern

  private[raylib] def __sn_wrap_raylib_MatrixRotateZ(angle : Float, __return : Ptr[Matrix]): Unit = extern

  private[raylib] def __sn_wrap_raylib_MatrixRotateZYX(angle : Ptr[Vector3], __return : Ptr[Matrix]): Unit = extern

  private[raylib] def __sn_wrap_raylib_MatrixScale(x : Float, y : Float, z : Float, __return : Ptr[Matrix]): Unit = extern

  private[raylib] def __sn_wrap_raylib_MatrixSubtract(left : Ptr[Matrix], right : Ptr[Matrix], __return : Ptr[Matrix]): Unit = extern

  private[raylib] def __sn_wrap_raylib_MatrixToFloatV(mat : Ptr[Matrix], __return : Ptr[float16]): Unit = extern

  private[raylib] def __sn_wrap_raylib_MatrixTrace(mat : Ptr[Matrix]): Float = extern

  private[raylib] def __sn_wrap_raylib_MatrixTranslate(x : Float, y : Float, z : Float, __return : Ptr[Matrix]): Unit = extern

  private[raylib] def __sn_wrap_raylib_MatrixTranspose(mat : Ptr[Matrix], __return : Ptr[Matrix]): Unit = extern

  private[raylib] def __sn_wrap_raylib_MeasureTextEx(font : Ptr[Font], text : CString, fontSize : Float, spacing : Float, __return : Ptr[Vector2]): Unit = extern

  private[raylib] def __sn_wrap_raylib_PauseAudioStream(stream : Ptr[AudioStream]): Unit = extern

  private[raylib] def __sn_wrap_raylib_PauseMusicStream(music : Ptr[Music]): Unit = extern

  private[raylib] def __sn_wrap_raylib_PauseSound(sound : Ptr[Sound]): Unit = extern

  private[raylib] def __sn_wrap_raylib_PlayAudioStream(stream : Ptr[AudioStream]): Unit = extern

  private[raylib] def __sn_wrap_raylib_PlayAutomationEvent(event : Ptr[AutomationEvent]): Unit = extern

  private[raylib] def __sn_wrap_raylib_PlayMusicStream(music : Ptr[Music]): Unit = extern

  private[raylib] def __sn_wrap_raylib_PlaySound(sound : Ptr[Sound]): Unit = extern

  private[raylib] def __sn_wrap_raylib_QuaternionAdd(q1 : Ptr[Quaternion], q2 : Ptr[Quaternion], __return : Ptr[Quaternion]): Unit = extern

  private[raylib] def __sn_wrap_raylib_QuaternionAddValue(q : Ptr[Quaternion], add : Float, __return : Ptr[Quaternion]): Unit = extern

  private[raylib] def __sn_wrap_raylib_QuaternionDivide(q1 : Ptr[Quaternion], q2 : Ptr[Quaternion], __return : Ptr[Quaternion]): Unit = extern

  private[raylib] def __sn_wrap_raylib_QuaternionEquals(p : Ptr[Quaternion], q : Ptr[Quaternion]): CInt = extern

  private[raylib] def __sn_wrap_raylib_QuaternionFromAxisAngle(axis : Ptr[Vector3], angle : Float, __return : Ptr[Quaternion]): Unit = extern

  private[raylib] def __sn_wrap_raylib_QuaternionFromEuler(pitch : Float, yaw : Float, roll : Float, __return : Ptr[Quaternion]): Unit = extern

  private[raylib] def __sn_wrap_raylib_QuaternionFromMatrix(mat : Ptr[Matrix], __return : Ptr[Quaternion]): Unit = extern

  private[raylib] def __sn_wrap_raylib_QuaternionFromVector3ToVector3(from : Ptr[Vector3], to : Ptr[Vector3], __return : Ptr[Quaternion]): Unit = extern

  private[raylib] def __sn_wrap_raylib_QuaternionIdentity(__return : Ptr[Quaternion]): Unit = extern

  private[raylib] def __sn_wrap_raylib_QuaternionInvert(q : Ptr[Quaternion], __return : Ptr[Quaternion]): Unit = extern

  private[raylib] def __sn_wrap_raylib_QuaternionLength(q : Ptr[Quaternion]): Float = extern

  private[raylib] def __sn_wrap_raylib_QuaternionLerp(q1 : Ptr[Quaternion], q2 : Ptr[Quaternion], amount : Float, __return : Ptr[Quaternion]): Unit = extern

  private[raylib] def __sn_wrap_raylib_QuaternionMultiply(q1 : Ptr[Quaternion], q2 : Ptr[Quaternion], __return : Ptr[Quaternion]): Unit = extern

  private[raylib] def __sn_wrap_raylib_QuaternionNlerp(q1 : Ptr[Quaternion], q2 : Ptr[Quaternion], amount : Float, __return : Ptr[Quaternion]): Unit = extern

  private[raylib] def __sn_wrap_raylib_QuaternionNormalize(q : Ptr[Quaternion], __return : Ptr[Quaternion]): Unit = extern

  private[raylib] def __sn_wrap_raylib_QuaternionScale(q : Ptr[Quaternion], mul : Float, __return : Ptr[Quaternion]): Unit = extern

  private[raylib] def __sn_wrap_raylib_QuaternionSlerp(q1 : Ptr[Quaternion], q2 : Ptr[Quaternion], amount : Float, __return : Ptr[Quaternion]): Unit = extern

  private[raylib] def __sn_wrap_raylib_QuaternionSubtract(q1 : Ptr[Quaternion], q2 : Ptr[Quaternion], __return : Ptr[Quaternion]): Unit = extern

  private[raylib] def __sn_wrap_raylib_QuaternionSubtractValue(q : Ptr[Quaternion], sub : Float, __return : Ptr[Quaternion]): Unit = extern

  private[raylib] def __sn_wrap_raylib_QuaternionToAxisAngle(q : Ptr[Quaternion], outAxis : Ptr[Vector3], outAngle : Ptr[Float]): Unit = extern

  private[raylib] def __sn_wrap_raylib_QuaternionToEuler(q : Ptr[Quaternion], __return : Ptr[Vector3]): Unit = extern

  private[raylib] def __sn_wrap_raylib_QuaternionToMatrix(q : Ptr[Quaternion], __return : Ptr[Matrix]): Unit = extern

  private[raylib] def __sn_wrap_raylib_QuaternionTransform(q : Ptr[Quaternion], mat : Ptr[Matrix], __return : Ptr[Quaternion]): Unit = extern

  private[raylib] def __sn_wrap_raylib_ResumeAudioStream(stream : Ptr[AudioStream]): Unit = extern

  private[raylib] def __sn_wrap_raylib_ResumeMusicStream(music : Ptr[Music]): Unit = extern

  private[raylib] def __sn_wrap_raylib_ResumeSound(sound : Ptr[Sound]): Unit = extern

  private[raylib] def __sn_wrap_raylib_SeekMusicStream(music : Ptr[Music], position : Float): Unit = extern

  private[raylib] def __sn_wrap_raylib_SetAudioStreamCallback(stream : Ptr[AudioStream], callback : AudioCallback): Unit = extern

  private[raylib] def __sn_wrap_raylib_SetAudioStreamPan(stream : Ptr[AudioStream], pan : Float): Unit = extern

  private[raylib] def __sn_wrap_raylib_SetAudioStreamPitch(stream : Ptr[AudioStream], pitch : Float): Unit = extern

  private[raylib] def __sn_wrap_raylib_SetAudioStreamVolume(stream : Ptr[AudioStream], volume : Float): Unit = extern

  private[raylib] def __sn_wrap_raylib_SetMaterialTexture(material : Ptr[Material], mapType : CInt, texture : Ptr[Texture2D]): Unit = extern

  private[raylib] def __sn_wrap_raylib_SetMusicPan(music : Ptr[Music], pan : Float): Unit = extern

  private[raylib] def __sn_wrap_raylib_SetMusicPitch(music : Ptr[Music], pitch : Float): Unit = extern

  private[raylib] def __sn_wrap_raylib_SetMusicVolume(music : Ptr[Music], volume : Float): Unit = extern

  private[raylib] def __sn_wrap_raylib_SetPixelColor(dstPtr : Ptr[Byte], color : Ptr[Color], format : CInt): Unit = extern

  private[raylib] def __sn_wrap_raylib_SetShaderValue(shader : Ptr[Shader], locIndex : CInt, value : Ptr[Byte], uniformType : CInt): Unit = extern

  private[raylib] def __sn_wrap_raylib_SetShaderValueMatrix(shader : Ptr[Shader], locIndex : CInt, mat : Ptr[Matrix]): Unit = extern

  private[raylib] def __sn_wrap_raylib_SetShaderValueTexture(shader : Ptr[Shader], locIndex : CInt, texture : Ptr[Texture2D]): Unit = extern

  private[raylib] def __sn_wrap_raylib_SetShaderValueV(shader : Ptr[Shader], locIndex : CInt, value : Ptr[Byte], uniformType : CInt, count : CInt): Unit = extern

  private[raylib] def __sn_wrap_raylib_SetShapesTexture(texture : Ptr[Texture2D], source : Ptr[Rectangle]): Unit = extern

  private[raylib] def __sn_wrap_raylib_SetSoundPan(sound : Ptr[Sound], pan : Float): Unit = extern

  private[raylib] def __sn_wrap_raylib_SetSoundPitch(sound : Ptr[Sound], pitch : Float): Unit = extern

  private[raylib] def __sn_wrap_raylib_SetSoundVolume(sound : Ptr[Sound], volume : Float): Unit = extern

  private[raylib] def __sn_wrap_raylib_SetTextureFilter(texture : Ptr[Texture2D], filter : CInt): Unit = extern

  private[raylib] def __sn_wrap_raylib_SetTextureWrap(texture : Ptr[Texture2D], wrap : CInt): Unit = extern

  private[raylib] def __sn_wrap_raylib_SetWindowIcon(image : Ptr[Image]): Unit = extern

  private[raylib] def __sn_wrap_raylib_StopAudioStream(stream : Ptr[AudioStream]): Unit = extern

  private[raylib] def __sn_wrap_raylib_StopMusicStream(music : Ptr[Music]): Unit = extern

  private[raylib] def __sn_wrap_raylib_StopSound(sound : Ptr[Sound]): Unit = extern

  private[raylib] def __sn_wrap_raylib_UnloadAudioStream(stream : Ptr[AudioStream]): Unit = extern

  private[raylib] def __sn_wrap_raylib_UnloadDirectoryFiles(files : Ptr[FilePathList]): Unit = extern

  private[raylib] def __sn_wrap_raylib_UnloadDroppedFiles(files : Ptr[FilePathList]): Unit = extern

  private[raylib] def __sn_wrap_raylib_UnloadFont(font : Ptr[Font]): Unit = extern

  private[raylib] def __sn_wrap_raylib_UnloadImage(image : Ptr[Image]): Unit = extern

  private[raylib] def __sn_wrap_raylib_UnloadMaterial(material : Ptr[Material]): Unit = extern

  private[raylib] def __sn_wrap_raylib_UnloadMesh(mesh : Ptr[Mesh]): Unit = extern

  private[raylib] def __sn_wrap_raylib_UnloadModel(model : Ptr[Model]): Unit = extern

  private[raylib] def __sn_wrap_raylib_UnloadModelAnimation(anim : Ptr[ModelAnimation]): Unit = extern

  private[raylib] def __sn_wrap_raylib_UnloadMusicStream(music : Ptr[Music]): Unit = extern

  private[raylib] def __sn_wrap_raylib_UnloadRenderTexture(target : Ptr[RenderTexture2D]): Unit = extern

  private[raylib] def __sn_wrap_raylib_UnloadShader(shader : Ptr[Shader]): Unit = extern

  private[raylib] def __sn_wrap_raylib_UnloadSound(sound : Ptr[Sound]): Unit = extern

  private[raylib] def __sn_wrap_raylib_UnloadSoundAlias(alias : Ptr[Sound]): Unit = extern

  private[raylib] def __sn_wrap_raylib_UnloadTexture(texture : Ptr[Texture2D]): Unit = extern

  private[raylib] def __sn_wrap_raylib_UnloadVrStereoConfig(config : Ptr[VrStereoConfig]): Unit = extern

  private[raylib] def __sn_wrap_raylib_UnloadWave(wave : Ptr[Wave]): Unit = extern

  private[raylib] def __sn_wrap_raylib_UpdateAudioStream(stream : Ptr[AudioStream], data : Ptr[Byte], frameCount : CInt): Unit = extern

  private[raylib] def __sn_wrap_raylib_UpdateCameraPro(camera : Ptr[Camera], movement : Ptr[Vector3], rotation : Ptr[Vector3], zoom : Float): Unit = extern

  private[raylib] def __sn_wrap_raylib_UpdateMeshBuffer(mesh : Ptr[Mesh], index : CInt, data : Ptr[Byte], dataSize : CInt, offset : CInt): Unit = extern

  private[raylib] def __sn_wrap_raylib_UpdateModelAnimation(model : Ptr[Model], anim : Ptr[ModelAnimation], frame : CInt): Unit = extern

  private[raylib] def __sn_wrap_raylib_UpdateMusicStream(music : Ptr[Music]): Unit = extern

  private[raylib] def __sn_wrap_raylib_UpdateSound(sound : Ptr[Sound], data : Ptr[Byte], sampleCount : CInt): Unit = extern

  private[raylib] def __sn_wrap_raylib_UpdateTexture(texture : Ptr[Texture2D], pixels : Ptr[Byte]): Unit = extern

  private[raylib] def __sn_wrap_raylib_UpdateTextureRec(texture : Ptr[Texture2D], rec : Ptr[Rectangle], pixels : Ptr[Byte]): Unit = extern

  private[raylib] def __sn_wrap_raylib_Vector2Add(v1 : Ptr[Vector2], v2 : Ptr[Vector2], __return : Ptr[Vector2]): Unit = extern

  private[raylib] def __sn_wrap_raylib_Vector2AddValue(v : Ptr[Vector2], add : Float, __return : Ptr[Vector2]): Unit = extern

  private[raylib] def __sn_wrap_raylib_Vector2Angle(v1 : Ptr[Vector2], v2 : Ptr[Vector2]): Float = extern

  private[raylib] def __sn_wrap_raylib_Vector2Clamp(v : Ptr[Vector2], min : Ptr[Vector2], max : Ptr[Vector2], __return : Ptr[Vector2]): Unit = extern

  private[raylib] def __sn_wrap_raylib_Vector2ClampValue(v : Ptr[Vector2], min : Float, max : Float, __return : Ptr[Vector2]): Unit = extern

  private[raylib] def __sn_wrap_raylib_Vector2Distance(v1 : Ptr[Vector2], v2 : Ptr[Vector2]): Float = extern

  private[raylib] def __sn_wrap_raylib_Vector2DistanceSqr(v1 : Ptr[Vector2], v2 : Ptr[Vector2]): Float = extern

  private[raylib] def __sn_wrap_raylib_Vector2Divide(v1 : Ptr[Vector2], v2 : Ptr[Vector2], __return : Ptr[Vector2]): Unit = extern

  private[raylib] def __sn_wrap_raylib_Vector2DotProduct(v1 : Ptr[Vector2], v2 : Ptr[Vector2]): Float = extern

  private[raylib] def __sn_wrap_raylib_Vector2Equals(p : Ptr[Vector2], q : Ptr[Vector2]): CInt = extern

  private[raylib] def __sn_wrap_raylib_Vector2Invert(v : Ptr[Vector2], __return : Ptr[Vector2]): Unit = extern

  private[raylib] def __sn_wrap_raylib_Vector2Length(v : Ptr[Vector2]): Float = extern

  private[raylib] def __sn_wrap_raylib_Vector2LengthSqr(v : Ptr[Vector2]): Float = extern

  private[raylib] def __sn_wrap_raylib_Vector2Lerp(v1 : Ptr[Vector2], v2 : Ptr[Vector2], amount : Float, __return : Ptr[Vector2]): Unit = extern

  private[raylib] def __sn_wrap_raylib_Vector2LineAngle(start : Ptr[Vector2], end : Ptr[Vector2]): Float = extern

  private[raylib] def __sn_wrap_raylib_Vector2MoveTowards(v : Ptr[Vector2], target : Ptr[Vector2], maxDistance : Float, __return : Ptr[Vector2]): Unit = extern

  private[raylib] def __sn_wrap_raylib_Vector2Multiply(v1 : Ptr[Vector2], v2 : Ptr[Vector2], __return : Ptr[Vector2]): Unit = extern

  private[raylib] def __sn_wrap_raylib_Vector2Negate(v : Ptr[Vector2], __return : Ptr[Vector2]): Unit = extern

  private[raylib] def __sn_wrap_raylib_Vector2Normalize(v : Ptr[Vector2], __return : Ptr[Vector2]): Unit = extern

  private[raylib] def __sn_wrap_raylib_Vector2One(__return : Ptr[Vector2]): Unit = extern

  private[raylib] def __sn_wrap_raylib_Vector2Reflect(v : Ptr[Vector2], normal : Ptr[Vector2], __return : Ptr[Vector2]): Unit = extern

  private[raylib] def __sn_wrap_raylib_Vector2Rotate(v : Ptr[Vector2], angle : Float, __return : Ptr[Vector2]): Unit = extern

  private[raylib] def __sn_wrap_raylib_Vector2Scale(v : Ptr[Vector2], scale : Float, __return : Ptr[Vector2]): Unit = extern

  private[raylib] def __sn_wrap_raylib_Vector2Subtract(v1 : Ptr[Vector2], v2 : Ptr[Vector2], __return : Ptr[Vector2]): Unit = extern

  private[raylib] def __sn_wrap_raylib_Vector2SubtractValue(v : Ptr[Vector2], sub : Float, __return : Ptr[Vector2]): Unit = extern

  private[raylib] def __sn_wrap_raylib_Vector2Transform(v : Ptr[Vector2], mat : Ptr[Matrix], __return : Ptr[Vector2]): Unit = extern

  private[raylib] def __sn_wrap_raylib_Vector2Zero(__return : Ptr[Vector2]): Unit = extern

  private[raylib] def __sn_wrap_raylib_Vector3Add(v1 : Ptr[Vector3], v2 : Ptr[Vector3], __return : Ptr[Vector3]): Unit = extern

  private[raylib] def __sn_wrap_raylib_Vector3AddValue(v : Ptr[Vector3], add : Float, __return : Ptr[Vector3]): Unit = extern

  private[raylib] def __sn_wrap_raylib_Vector3Angle(v1 : Ptr[Vector3], v2 : Ptr[Vector3]): Float = extern

  private[raylib] def __sn_wrap_raylib_Vector3Barycenter(p : Ptr[Vector3], a : Ptr[Vector3], b : Ptr[Vector3], c : Ptr[Vector3], __return : Ptr[Vector3]): Unit = extern

  private[raylib] def __sn_wrap_raylib_Vector3Clamp(v : Ptr[Vector3], min : Ptr[Vector3], max : Ptr[Vector3], __return : Ptr[Vector3]): Unit = extern

  private[raylib] def __sn_wrap_raylib_Vector3ClampValue(v : Ptr[Vector3], min : Float, max : Float, __return : Ptr[Vector3]): Unit = extern

  private[raylib] def __sn_wrap_raylib_Vector3CrossProduct(v1 : Ptr[Vector3], v2 : Ptr[Vector3], __return : Ptr[Vector3]): Unit = extern

  private[raylib] def __sn_wrap_raylib_Vector3Distance(v1 : Ptr[Vector3], v2 : Ptr[Vector3]): Float = extern

  private[raylib] def __sn_wrap_raylib_Vector3DistanceSqr(v1 : Ptr[Vector3], v2 : Ptr[Vector3]): Float = extern

  private[raylib] def __sn_wrap_raylib_Vector3Divide(v1 : Ptr[Vector3], v2 : Ptr[Vector3], __return : Ptr[Vector3]): Unit = extern

  private[raylib] def __sn_wrap_raylib_Vector3DotProduct(v1 : Ptr[Vector3], v2 : Ptr[Vector3]): Float = extern

  private[raylib] def __sn_wrap_raylib_Vector3Equals(p : Ptr[Vector3], q : Ptr[Vector3]): CInt = extern

  private[raylib] def __sn_wrap_raylib_Vector3Invert(v : Ptr[Vector3], __return : Ptr[Vector3]): Unit = extern

  private[raylib] def __sn_wrap_raylib_Vector3Length(v : Ptr[Vector3]): Float = extern

  private[raylib] def __sn_wrap_raylib_Vector3LengthSqr(v : Ptr[Vector3]): Float = extern

  private[raylib] def __sn_wrap_raylib_Vector3Lerp(v1 : Ptr[Vector3], v2 : Ptr[Vector3], amount : Float, __return : Ptr[Vector3]): Unit = extern

  private[raylib] def __sn_wrap_raylib_Vector3Max(v1 : Ptr[Vector3], v2 : Ptr[Vector3], __return : Ptr[Vector3]): Unit = extern

  private[raylib] def __sn_wrap_raylib_Vector3Min(v1 : Ptr[Vector3], v2 : Ptr[Vector3], __return : Ptr[Vector3]): Unit = extern

  private[raylib] def __sn_wrap_raylib_Vector3Multiply(v1 : Ptr[Vector3], v2 : Ptr[Vector3], __return : Ptr[Vector3]): Unit = extern

  private[raylib] def __sn_wrap_raylib_Vector3Negate(v : Ptr[Vector3], __return : Ptr[Vector3]): Unit = extern

  private[raylib] def __sn_wrap_raylib_Vector3Normalize(v : Ptr[Vector3], __return : Ptr[Vector3]): Unit = extern

  private[raylib] def __sn_wrap_raylib_Vector3One(__return : Ptr[Vector3]): Unit = extern

  private[raylib] def __sn_wrap_raylib_Vector3Perpendicular(v : Ptr[Vector3], __return : Ptr[Vector3]): Unit = extern

  private[raylib] def __sn_wrap_raylib_Vector3Project(v1 : Ptr[Vector3], v2 : Ptr[Vector3], __return : Ptr[Vector3]): Unit = extern

  private[raylib] def __sn_wrap_raylib_Vector3Reflect(v : Ptr[Vector3], normal : Ptr[Vector3], __return : Ptr[Vector3]): Unit = extern

  private[raylib] def __sn_wrap_raylib_Vector3Refract(v : Ptr[Vector3], n : Ptr[Vector3], r : Float, __return : Ptr[Vector3]): Unit = extern

  private[raylib] def __sn_wrap_raylib_Vector3Reject(v1 : Ptr[Vector3], v2 : Ptr[Vector3], __return : Ptr[Vector3]): Unit = extern

  private[raylib] def __sn_wrap_raylib_Vector3RotateByAxisAngle(v : Ptr[Vector3], axis : Ptr[Vector3], angle : Float, __return : Ptr[Vector3]): Unit = extern

  private[raylib] def __sn_wrap_raylib_Vector3RotateByQuaternion(v : Ptr[Vector3], q : Ptr[Quaternion], __return : Ptr[Vector3]): Unit = extern

  private[raylib] def __sn_wrap_raylib_Vector3Scale(v : Ptr[Vector3], scalar : Float, __return : Ptr[Vector3]): Unit = extern

  private[raylib] def __sn_wrap_raylib_Vector3Subtract(v1 : Ptr[Vector3], v2 : Ptr[Vector3], __return : Ptr[Vector3]): Unit = extern

  private[raylib] def __sn_wrap_raylib_Vector3SubtractValue(v : Ptr[Vector3], sub : Float, __return : Ptr[Vector3]): Unit = extern

  private[raylib] def __sn_wrap_raylib_Vector3ToFloatV(v : Ptr[Vector3], __return : Ptr[float3]): Unit = extern

  private[raylib] def __sn_wrap_raylib_Vector3Transform(v : Ptr[Vector3], mat : Ptr[Matrix], __return : Ptr[Vector3]): Unit = extern

  private[raylib] def __sn_wrap_raylib_Vector3Unproject(source : Ptr[Vector3], projection : Ptr[Matrix], view : Ptr[Matrix], __return : Ptr[Vector3]): Unit = extern

  private[raylib] def __sn_wrap_raylib_Vector3Zero(__return : Ptr[Vector3]): Unit = extern

  private[raylib] def __sn_wrap_raylib_WaveCopy(wave : Ptr[Wave], __return : Ptr[Wave]): Unit = extern
...
object functions:
  ...
  */
  def DrawBillboard(camera : Camera, texture : Texture2D, position : Vector3, size : Float, tint : Color)(using Zone): Unit = 
    ...
    !(__ptr_3 + 0) = position
    !(__ptr_0 + 0) = tint
    __sn_wrap_raylib_DrawBillboard((__ptr_2 + 0), (__ptr_1 + 0), (__ptr_3 + 0), size, (__ptr_0 + 0))

  /**
   * [bindgen] header: ./raylib/src/raylib.h
  */
  def DrawBillboard(camera : Ptr[Camera], texture : Ptr[Texture2D], position : Ptr[Vector3], size : Float, tint : Ptr[Color]): Unit = 
  ...
  */
  def DrawBillboardPro(camera : Camera, texture : Texture2D, source : Rectangle, position : Vector3, up : Vector3, size : Vector2, origin : Vector2, rotation : Float, tint : Color)(using Zone): Unit = 
    ...
    !(__ptr_4 + 1) = origin
    !(__ptr_0 + 0) = tint
    __sn_wrap_raylib_DrawBillboardPro((__ptr_2 + 0), (__ptr_1 + 0), (__ptr_3 + 0), (__ptr_5 + 0), (__ptr_5 + 1), (__ptr_4 + 0), (__ptr_4 + 1), rotation, (__ptr_0 + 0))
  ...
  */
  def DrawBillboardRec(camera : Camera, texture : Texture2D, source : Rectangle, position : Vector3, size : Vector2, tint : Color)(using Zone): Unit = 
    ...
    !(__ptr_4 + 0) = size
    !(__ptr_0 + 0) = tint
    __sn_wrap_raylib_DrawBillboardRec((__ptr_2 + 0), (__ptr_1 + 0), (__ptr_3 + 0), (__ptr_5 + 0), (__ptr_4 + 0), (__ptr_0 + 0))
  ...
  */
  def DrawCapsule(startPos : Vector3, endPos : Vector3, radius : Float, slices : CInt, rings : CInt, color : Color)(using Zone): Unit = 
    ...
    !(__ptr_1 + 1) = endPos
    !(__ptr_0 + 0) = color
    __sn_wrap_raylib_DrawCapsule((__ptr_1 + 0), (__ptr_1 + 1), radius, slices, rings, (__ptr_0 + 0))
  ...
  */
  def DrawCapsuleWires(startPos : Vector3, endPos : Vector3, radius : Float, slices : CInt, rings : CInt, color : Color)(using Zone): Unit = 
    ...
    !(__ptr_1 + 1) = endPos
    !(__ptr_0 + 0) = color
    __sn_wrap_raylib_DrawCapsuleWires((__ptr_1 + 0), (__ptr_1 + 1), radius, slices, rings, (__ptr_0 + 0))
  ...
  */
  def DrawCircle3D(center : Vector3, radius : Float, rotationAxis : Vector3, rotationAngle : Float, color : Color)(using Zone): Unit = 
    ...
    !(__ptr_0 + 0) = color
    __sn_wrap_raylib_DrawCircle3D((__ptr_1 + 0), radius, (__ptr_1 + 1), rotationAngle, (__ptr_0 + 0))
  ...
  */
   ...
   * [bindgen] header: ./raylib/src/raylib.h
  */
  def DrawCircleGradient(centerX : CInt, centerY : CInt, radius : Float, color1 : Ptr[Color], color2 : Ptr[Color]): Unit = 
  ...
  */
  def DrawCircleSector(center : Vector2, radius : Float, startAngle : Float, endAngle : Float, segments : CInt, color : Color)(using Zone): Unit = 
    ...
    !(__ptr_1 + 0) = center
    !(__ptr_0 + 0) = color
    __sn_wrap_raylib_DrawCircleSector((__ptr_1 + 0), radius, startAngle, endAngle, segments, (__ptr_0 + 0))
  ...
  */
  def DrawCircleSectorLines(center : Vector2, radius : Float, startAngle : Float, endAngle : Float, segments : CInt, color : Color)(using Zone): Unit = 
    ...
    !(__ptr_1 + 0) = center
    !(__ptr_0 + 0) = color
    __sn_wrap_raylib_DrawCircleSectorLines((__ptr_1 + 0), radius, startAngle, endAngle, segments, (__ptr_0 + 0))
  ...
  */
  def DrawCubeWires(position : Vector3, width : Float, height : Float, length : Float, color : Color)(using Zone): Unit = 
    ...
    !(__ptr_1 + 0) = position
    !(__ptr_0 + 0) = color
    __sn_wrap_raylib_DrawCubeWires((__ptr_1 + 0), width, height, length, (__ptr_0 + 0))
  ...
  */
  def DrawCylinder(position : Vector3, radiusTop : Float, radiusBottom : Float, height : Float, slices : CInt, color : Color)(using Zone): Unit = 
    ...
    !(__ptr_1 + 0) = position
    !(__ptr_0 + 0) = color
    __sn_wrap_raylib_DrawCylinder((__ptr_1 + 0), radiusTop, radiusBottom, height, slices, (__ptr_0 + 0))
  ...
  */
  def DrawCylinderEx(startPos : Vector3, endPos : Vector3, startRadius : Float, endRadius : Float, sides : CInt, color : Color)(using Zone): Unit = 
    ...
    !(__ptr_1 + 1) = endPos
    !(__ptr_0 + 0) = color
    __sn_wrap_raylib_DrawCylinderEx((__ptr_1 + 0), (__ptr_1 + 1), startRadius, endRadius, sides, (__ptr_0 + 0))
  ...
  */
  def DrawCylinderWires(position : Vector3, radiusTop : Float, radiusBottom : Float, height : Float, slices : CInt, color : Color)(using Zone): Unit = 
    ...
    !(__ptr_1 + 0) = position
    !(__ptr_0 + 0) = color
    __sn_wrap_raylib_DrawCylinderWires((__ptr_1 + 0), radiusTop, radiusBottom, height, slices, (__ptr_0 + 0))
  ...
  */
  def DrawCylinderWiresEx(startPos : Vector3, endPos : Vector3, startRadius : Float, endRadius : Float, sides : CInt, color : Color)(using Zone): Unit = 
    ...
    !(__ptr_1 + 1) = endPos
    !(__ptr_0 + 0) = color
    __sn_wrap_raylib_DrawCylinderWiresEx((__ptr_1 + 0), (__ptr_1 + 1), startRadius, endRadius, sides, (__ptr_0 + 0))
  ...
  */
  def DrawLineBezier(startPos : Vector2, endPos : Vector2, thick : Float, color : Color)(using Zone): Unit = 
    ...
    !(__ptr_1 + 1) = endPos
    !(__ptr_0 + 0) = color
    __sn_wrap_raylib_DrawLineBezier((__ptr_1 + 0), (__ptr_1 + 1), thick, (__ptr_0 + 0))
  ...
  */
  def DrawLineEx(startPos : Vector2, endPos : Vector2, thick : Float, color : Color)(using Zone): Unit = 
    ...
    !(__ptr_1 + 1) = endPos
    !(__ptr_0 + 0) = color
    __sn_wrap_raylib_DrawLineEx((__ptr_1 + 0), (__ptr_1 + 1), thick, (__ptr_0 + 0))
  ...
  */
  def DrawMeshInstanced(mesh : Mesh, material : Material, transforms : Ptr[Matrix], instances : CInt)(using Zone): Unit = 
    ...
    !(__ptr_0 + 0) = mesh
    !(__ptr_1 + 0) = material
    __sn_wrap_raylib_DrawMeshInstanced((__ptr_0 + 0), (__ptr_1 + 0), transforms, instances)
  ...
  */
  def DrawModelEx(model : Model, position : Vector3, rotationAxis : Vector3, rotationAngle : Float, scale : Vector3, tint : Color)(using Zone): Unit = 
    ...
    !(__ptr_2 + 2) = scale
    !(__ptr_0 + 0) = tint
    __sn_wrap_raylib_DrawModelEx((__ptr_1 + 0), (__ptr_2 + 0), (__ptr_2 + 1), rotationAngle, (__ptr_2 + 2), (__ptr_0 + 0))
  ...
  */
  def DrawModelWires(model : Model, position : Vector3, scale : Float, tint : Color)(using Zone): Unit = 
    ...
    !(__ptr_2 + 0) = position
    !(__ptr_0 + 0) = tint
    __sn_wrap_raylib_DrawModelWires((__ptr_1 + 0), (__ptr_2 + 0), scale, (__ptr_0 + 0))
  ...
  */
  def DrawModelWiresEx(model : Model, position : Vector3, rotationAxis : Vector3, rotationAngle : Float, scale : Vector3, tint : Color)(using Zone): Unit = 
    ...
    !(__ptr_2 + 2) = scale
    !(__ptr_0 + 0) = tint
    __sn_wrap_raylib_DrawModelWiresEx((__ptr_1 + 0), (__ptr_2 + 0), (__ptr_2 + 1), rotationAngle, (__ptr_2 + 2), (__ptr_0 + 0))
  ...
  */
  def DrawPoly(center : Vector2, sides : CInt, radius : Float, rotation : Float, color : Color)(using Zone): Unit = 
    ...
    !(__ptr_1 + 0) = center
    !(__ptr_0 + 0) = color
    __sn_wrap_raylib_DrawPoly((__ptr_1 + 0), sides, radius, rotation, (__ptr_0 + 0))
  ...
  */
  def DrawPolyLines(center : Vector2, sides : CInt, radius : Float, rotation : Float, color : Color)(using Zone): Unit = 
    ...
    !(__ptr_1 + 0) = center
    !(__ptr_0 + 0) = color
    __sn_wrap_raylib_DrawPolyLines((__ptr_1 + 0), sides, radius, rotation, (__ptr_0 + 0))
  ...
  */
  def DrawPolyLinesEx(center : Vector2, sides : CInt, radius : Float, rotation : Float, lineThick : Float, color : Color)(using Zone): Unit = 
    ...
    !(__ptr_1 + 0) = center
    !(__ptr_0 + 0) = color
    __sn_wrap_raylib_DrawPolyLinesEx((__ptr_1 + 0), sides, radius, rotation, lineThick, (__ptr_0 + 0))
  ...
  */
  def DrawRectangleGradientEx(rec : Rectangle, col1 : Color, col2 : Color, col3 : Color, col4 : Color)(using Zone): Unit = 
    ...
    !(__ptr_0 + 2) = col3
    !(__ptr_0 + 3) = col4
    __sn_wrap_raylib_DrawRectangleGradientEx((__ptr_1 + 0), (__ptr_0 + 0), (__ptr_0 + 1), (__ptr_0 + 2), (__ptr_0 + 3))

  /**
   * [bindgen] header: ./raylib/src/raylib.h
  */
  def DrawRectangleGradientEx(rec : Ptr[Rectangle], col1 : Ptr[Color], col2 : Ptr[Color], col3 : Ptr[Color], col4 : Ptr[Color]): Unit = 
    __sn_wrap_raylib_DrawRectangleGradientEx(rec, col1, col2, col3, col4)

  /**
   * [bindgen] header: ./raylib/src/raylib.h
  */
  def DrawRectangleGradientH(posX : CInt, posY : CInt, width : CInt, height : CInt, color1 : Ptr[Color], color2 : Ptr[Color]): Unit = 
    __sn_wrap_raylib_DrawRectangleGradientH(posX, posY, width, height, color1, color2)
  ...
  */
   ...
   * [bindgen] header: ./raylib/src/raylib.h
  */
  def DrawRectangleGradientV(posX : CInt, posY : CInt, width : CInt, height : CInt, color1 : Ptr[Color], color2 : Ptr[Color]): Unit = 
    __sn_wrap_raylib_DrawRectangleGradientV(posX, posY, width, height, color1, color2)
  ...
  */
  def DrawRectanglePro(rec : Rectangle, origin : Vector2, rotation : Float, color : Color)(using Zone): Unit = 
    ...
    !(__ptr_1 + 0) = origin
    !(__ptr_0 + 0) = color
    __sn_wrap_raylib_DrawRectanglePro((__ptr_2 + 0), (__ptr_1 + 0), rotation, (__ptr_0 + 0))
  ...
  */
  def DrawRectangleRounded(rec : Rectangle, roundness : Float, segments : CInt, color : Color)(using Zone): Unit = 
    ...
    !(__ptr_1 + 0) = rec
    !(__ptr_0 + 0) = color
    __sn_wrap_raylib_DrawRectangleRounded((__ptr_1 + 0), roundness, segments, (__ptr_0 + 0))

  /**
   * [bindgen] header: ./raylib/src/raylib.h
  */
  def DrawRectangleRoundedLines(rec : Ptr[Rectangle], roundness : Float, segments : CInt, lineThick : Float, color : Ptr[Color]): Unit = 
    __sn_wrap_raylib_DrawRectangleRoundedLines(rec, roundness, segments, lineThick, color)
  ...
  */
  def DrawRectangleRoundedLines(rec : Rectangle, roundness : Float, segments : CInt, lineThick : Float, color : Color)(using Zone): Unit = 
    ...
    !(__ptr_1 + 0) = rec
    !(__ptr_0 + 0) = color
    __sn_wrap_raylib_DrawRectangleRoundedLines((__ptr_1 + 0), roundness, segments, lineThick, (__ptr_0 + 0))
  ...
  */
  def DrawRing(center : Vector2, innerRadius : Float, outerRadius : Float, startAngle : Float, endAngle : Float, segments : CInt, color : Color)(using Zone): Unit = 
    ...
    !(__ptr_1 + 0) = center
    !(__ptr_0 + 0) = color
    __sn_wrap_raylib_DrawRing((__ptr_1 + 0), innerRadius, outerRadius, startAngle, endAngle, segments, (__ptr_0 + 0))
  ...
  */
  def DrawRingLines(center : Vector2, innerRadius : Float, outerRadius : Float, startAngle : Float, endAngle : Float, segments : CInt, color : Color)(using Zone): Unit = 
    ...
    !(__ptr_1 + 0) = center
    !(__ptr_0 + 0) = color
    __sn_wrap_raylib_DrawRingLines((__ptr_1 + 0), innerRadius, outerRadius, startAngle, endAngle, segments, (__ptr_0 + 0))
  ...
  */
  def DrawSphereEx(centerPos : Vector3, radius : Float, rings : CInt, slices : CInt, color : Color)(using Zone): Unit = 
    ...
    !(__ptr_1 + 0) = centerPos
    !(__ptr_0 + 0) = color
    __sn_wrap_raylib_DrawSphereEx((__ptr_1 + 0), radius, rings, slices, (__ptr_0 + 0))
  ...
  */
  def DrawSphereWires(centerPos : Vector3, radius : Float, rings : CInt, slices : CInt, color : Color)(using Zone): Unit = 
    ...
    !(__ptr_1 + 0) = centerPos
    !(__ptr_0 + 0) = color
    __sn_wrap_raylib_DrawSphereWires((__ptr_1 + 0), radius, rings, slices, (__ptr_0 + 0))
  ...
  */
  def DrawSplineSegmentBasis(p1 : Vector2, p2 : Vector2, p3 : Vector2, p4 : Vector2, thick : Float, color : Color)(using Zone): Unit = 
    ...
    !(__ptr_1 + 3) = p4
    !(__ptr_0 + 0) = color
    __sn_wrap_raylib_DrawSplineSegmentBasis((__ptr_1 + 0), (__ptr_1 + 1), (__ptr_1 + 2), (__ptr_1 + 3), thick, (__ptr_0 + 0))
  ...
  */
  def DrawSplineSegmentBezierCubic(p1 : Vector2, c2 : Vector2, c3 : Vector2, p4 : Vector2, thick : Float, color : Color)(using Zone): Unit = 
    ...
    !(__ptr_1 + 3) = p4
    !(__ptr_0 + 0) = color
    __sn_wrap_raylib_DrawSplineSegmentBezierCubic((__ptr_1 + 0), (__ptr_1 + 1), (__ptr_1 + 2), (__ptr_1 + 3), thick, (__ptr_0 + 0))
  ...
  */
  def DrawSplineSegmentBezierQuadratic(p1 : Vector2, c2 : Vector2, p3 : Vector2, thick : Float, color : Color)(using Zone): Unit = 
    ...
    !(__ptr_1 + 2) = p3
    !(__ptr_0 + 0) = color
    __sn_wrap_raylib_DrawSplineSegmentBezierQuadratic((__ptr_1 + 0), (__ptr_1 + 1), (__ptr_1 + 2), thick, (__ptr_0 + 0))
  ...
  */
  def DrawSplineSegmentCatmullRom(p1 : Vector2, p2 : Vector2, p3 : Vector2, p4 : Vector2, thick : Float, color : Color)(using Zone): Unit = 
    ...
    !(__ptr_1 + 3) = p4
    !(__ptr_0 + 0) = color
    __sn_wrap_raylib_DrawSplineSegmentCatmullRom((__ptr_1 + 0), (__ptr_1 + 1), (__ptr_1 + 2), (__ptr_1 + 3), thick, (__ptr_0 + 0))
  ...
  */
  def DrawSplineSegmentLinear(p1 : Vector2, p2 : Vector2, thick : Float, color : Color)(using Zone): Unit = 
    ...
    !(__ptr_1 + 1) = p2
    !(__ptr_0 + 0) = color
    __sn_wrap_raylib_DrawSplineSegmentLinear((__ptr_1 + 0), (__ptr_1 + 1), thick, (__ptr_0 + 0))
  ...
  */
  def DrawTextCodepoint(font : Font, codepoint : CInt, position : Vector2, fontSize : Float, tint : Color)(using Zone): Unit = 
    ...
    !(__ptr_1 + 0) = position
    !(__ptr_0 + 0) = tint
    __sn_wrap_raylib_DrawTextCodepoint((__ptr_2 + 0), codepoint, (__ptr_1 + 0), fontSize, (__ptr_0 + 0))
  ...
  */
  def DrawTextCodepoints(font : Font, codepoints : Ptr[CInt], codepointCount : CInt, position : Vector2, fontSize : Float, spacing : Float, tint : Color)(using Zone): Unit = 
    ...
    !(__ptr_1 + 0) = position
    !(__ptr_0 + 0) = tint
    __sn_wrap_raylib_DrawTextCodepoints((__ptr_2 + 0), codepoints, codepointCount, (__ptr_1 + 0), fontSize, spacing, (__ptr_0 + 0))
  ...
  */
  def DrawTextEx(font : Font, text : CString, position : Vector2, fontSize : Float, spacing : Float, tint : Color)(using Zone): Unit = 
    ...
    !(__ptr_1 + 0) = position
    !(__ptr_0 + 0) = tint
    __sn_wrap_raylib_DrawTextEx((__ptr_2 + 0), text, (__ptr_1 + 0), fontSize, spacing, (__ptr_0 + 0))
  ...
  */
  def DrawTextPro(font : Font, text : CString, position : Vector2, origin : Vector2, rotation : Float, fontSize : Float, spacing : Float, tint : Color)(using Zone): Unit = 
    ...
    !(__ptr_1 + 1) = origin
    !(__ptr_0 + 0) = tint
    __sn_wrap_raylib_DrawTextPro((__ptr_2 + 0), text, (__ptr_1 + 0), (__ptr_1 + 1), rotation, fontSize, spacing, (__ptr_0 + 0))
  ...
  */
  def DrawTextureEx(texture : Texture2D, position : Vector2, rotation : Float, scale : Float, tint : Color)(using Zone): Unit = 
    ...
    !(__ptr_1 + 0) = position
    !(__ptr_0 + 0) = tint
    __sn_wrap_raylib_DrawTextureEx((__ptr_2 + 0), (__ptr_1 + 0), rotation, scale, (__ptr_0 + 0))
  ...
  */
  def DrawTextureNPatch(texture : Texture2D, nPatchInfo : NPatchInfo, dest : Rectangle, origin : Vector2, rotation : Float, tint : Color)(using Zone): Unit = 
    ...
    !(__ptr_1 + 0) = origin
    !(__ptr_0 + 0) = tint
    __sn_wrap_raylib_DrawTextureNPatch((__ptr_3 + 0), (__ptr_2 + 0), (__ptr_4 + 0), (__ptr_1 + 0), rotation, (__ptr_0 + 0))
  ...
  */
  def DrawTexturePro(texture : Texture2D, source : Rectangle, dest : Rectangle, origin : Vector2, rotation : Float, tint : Color)(using Zone): Unit = 
    ...
    !(__ptr_1 + 0) = origin
    !(__ptr_0 + 0) = tint
    __sn_wrap_raylib_DrawTexturePro((__ptr_2 + 0), (__ptr_3 + 0), (__ptr_3 + 1), (__ptr_1 + 0), rotation, (__ptr_0 + 0))
  ...
  */
  def DrawTextureRec(texture : Texture2D, source : Rectangle, position : Vector2, tint : Color)(using Zone): Unit = 
    ...
    !(__ptr_1 + 0) = position
    !(__ptr_0 + 0) = tint
    __sn_wrap_raylib_DrawTextureRec((__ptr_2 + 0), (__ptr_3 + 0), (__ptr_1 + 0), (__ptr_0 + 0))
  ...
  */
  def DrawTriangle(v1 : Vector2, v2 : Vector2, v3 : Vector2, color : Color)(using Zone): Unit = 
    ...
    !(__ptr_1 + 2) = v3
    !(__ptr_0 + 0) = color
    __sn_wrap_raylib_DrawTriangle((__ptr_1 + 0), (__ptr_1 + 1), (__ptr_1 + 2), (__ptr_0 + 0))
  ...
  */
  def DrawTriangle3D(v1 : Vector3, v2 : Vector3, v3 : Vector3, color : Color)(using Zone): Unit = 
    ...
    !(__ptr_1 + 2) = v3
    !(__ptr_0 + 0) = color
    __sn_wrap_raylib_DrawTriangle3D((__ptr_1 + 0), (__ptr_1 + 1), (__ptr_1 + 2), (__ptr_0 + 0))
  ...
  */
  def DrawTriangleLines(v1 : Vector2, v2 : Vector2, v3 : Vector2, color : Color)(using Zone): Unit = 
    ...
    !(__ptr_1 + 2) = v3
    !(__ptr_0 + 0) = color
    __sn_wrap_raylib_DrawTriangleLines((__ptr_1 + 0), (__ptr_1 + 1), (__ptr_1 + 2), (__ptr_0 + 0))
  ...
  */
  def GenImageChecked(width : CInt, height : CInt, checksX : CInt, checksY : CInt, col1 : Color, col2 : Color)(using Zone): Image = 
    ...
    !(__ptr_0 + 0) = col1
    !(__ptr_0 + 1) = col2
    __sn_wrap_raylib_GenImageChecked(width, height, checksX, checksY, (__ptr_0 + 0), (__ptr_0 + 1), (__ptr_1 + 0))
    !(__ptr_1 + 0)
  ...
  */
  def GenImageGradientLinear(width : CInt, height : CInt, direction : CInt, start : Color, end : Color)(using Zone): Image = 
    ...
    !(__ptr_0 + 0) = start
    !(__ptr_0 + 1) = end
    __sn_wrap_raylib_GenImageGradientLinear(width, height, direction, (__ptr_0 + 0), (__ptr_0 + 1), (__ptr_1 + 0))
    !(__ptr_1 + 0)
  ...
  */
  def GenImageGradientRadial(width : CInt, height : CInt, density : Float, inner : Color, outer : Color)(using Zone): Image = 
    ...
    !(__ptr_0 + 0) = inner
    !(__ptr_0 + 1) = outer
    __sn_wrap_raylib_GenImageGradientRadial(width, height, density, (__ptr_0 + 0), (__ptr_0 + 1), (__ptr_1 + 0))
    !(__ptr_1 + 0)
  ...
  */
  def GenImageGradientSquare(width : CInt, height : CInt, density : Float, inner : Color, outer : Color)(using Zone): Image = 
    ...
    !(__ptr_0 + 0) = inner
    !(__ptr_0 + 1) = outer
    __sn_wrap_raylib_GenImageGradientSquare(width, height, density, (__ptr_0 + 0), (__ptr_0 + 1), (__ptr_1 + 0))
    !(__ptr_1 + 0)
  ...
  */
   ...
   * [bindgen] header: ./raylib/src/raylib.h
  */
  def GetMouseRay(mousePosition : Ptr[Vector2], camera : Ptr[Camera])(using Zone): Ray = 
   ...
   * [bindgen] header: ./raylib/src/raylib.h
  */
  def GetMouseRay(mousePosition : Ptr[Vector2], camera : Ptr[Camera])(__return : Ptr[Ray]): Unit = 
  ...
  */
  def GetRayCollisionBox(ray : Ray, box : BoundingBox)(using Zone): RayCollision = 
    ...
    !(__ptr_1 + 0) = ray
    !(__ptr_0 + 0) = box
    __sn_wrap_raylib_GetRayCollisionBox((__ptr_1 + 0), (__ptr_0 + 0), (__ptr_2 + 0))
    !(__ptr_2 + 0)
  ...
  */
  def GetRayCollisionMesh(ray : Ray, mesh : Mesh, transform : Matrix)(using Zone): RayCollision = 
    ...
    !(__ptr_1 + 0) = mesh
    !(__ptr_3 + 0) = transform
    __sn_wrap_raylib_GetRayCollisionMesh((__ptr_0 + 0), (__ptr_1 + 0), (__ptr_3 + 0), (__ptr_2 + 0))
    !(__ptr_2 + 0)
  ...
  */
  def GetRayCollisionQuad(ray : Ray, p1 : Vector3, p2 : Vector3, p3 : Vector3, p4 : Vector3)(using Zone): RayCollision = 
    ...
    !(__ptr_2 + 2) = p3
    !(__ptr_2 + 3) = p4
    __sn_wrap_raylib_GetRayCollisionQuad((__ptr_0 + 0), (__ptr_2 + 0), (__ptr_2 + 1), (__ptr_2 + 2), (__ptr_2 + 3), (__ptr_1 + 0))
    !(__ptr_1 + 0)
  ...
  */
  def GetRayCollisionSphere(ray : Ray, center : Vector3, radius : Float)(using Zone): RayCollision = 
    ...
    !(__ptr_0 + 0) = ray
    !(__ptr_2 + 0) = center
    __sn_wrap_raylib_GetRayCollisionSphere((__ptr_0 + 0), (__ptr_2 + 0), radius, (__ptr_1 + 0))
    !(__ptr_1 + 0)
  ...
  */
  def GetRayCollisionTriangle(ray : Ray, p1 : Vector3, p2 : Vector3, p3 : Vector3)(using Zone): RayCollision = 
    ...
    !(__ptr_2 + 1) = p2
    !(__ptr_2 + 2) = p3
    __sn_wrap_raylib_GetRayCollisionTriangle((__ptr_0 + 0), (__ptr_2 + 0), (__ptr_2 + 1), (__ptr_2 + 2), (__ptr_1 + 0))
    !(__ptr_1 + 0)
  ...
  */
  def GetWorldToScreenEx(position : Vector3, camera : Camera, width : CInt, height : CInt)(using Zone): Vector2 = 
    ...
    !(__ptr_2 + 0) = position
    !(__ptr_1 + 0) = camera
    __sn_wrap_raylib_GetWorldToScreenEx((__ptr_2 + 0), (__ptr_1 + 0), width, height, (__ptr_0 + 0))
    !(__ptr_0 + 0)
  ...
  */
  def ImageDraw(dst : Ptr[Image], src : Image, srcRec : Rectangle, dstRec : Rectangle, tint : Color)(using Zone): Unit = 
    ...
    !(__ptr_1 + 1) = dstRec
    !(__ptr_0 + 0) = tint
    __sn_wrap_raylib_ImageDraw(dst, (__ptr_2 + 0), (__ptr_1 + 0), (__ptr_1 + 1), (__ptr_0 + 0))
  ...
  */
  def ImageDrawCircleLinesV(dst : Ptr[Image], center : Vector2, radius : CInt, color : Color)(using Zone): Unit = 
    ...
    !(__ptr_1 + 0) = center
    !(__ptr_0 + 0) = color
    __sn_wrap_raylib_ImageDrawCircleLinesV(dst, (__ptr_1 + 0), radius, (__ptr_0 + 0))
  ...
  */
  def ImageDrawLineV(dst : Ptr[Image], start : Vector2, end : Vector2, color : Color)(using Zone): Unit = 
    ...
    !(__ptr_1 + 1) = end
    !(__ptr_0 + 0) = color
    __sn_wrap_raylib_ImageDrawLineV(dst, (__ptr_1 + 0), (__ptr_1 + 1), (__ptr_0 + 0))
  ...
  */
  def ImageDrawRectangleLines(dst : Ptr[Image], rec : Rectangle, thick : CInt, color : Color)(using Zone): Unit = 
    ...
    !(__ptr_1 + 0) = rec
    !(__ptr_0 + 0) = color
    __sn_wrap_raylib_ImageDrawRectangleLines(dst, (__ptr_1 + 0), thick, (__ptr_0 + 0))
  ...
  */
  def ImageDrawRectangleV(dst : Ptr[Image], position : Vector2, size : Vector2, color : Color)(using Zone): Unit = 
    ...
    !(__ptr_1 + 1) = size
    !(__ptr_0 + 0) = color
    __sn_wrap_raylib_ImageDrawRectangleV(dst, (__ptr_1 + 0), (__ptr_1 + 1), (__ptr_0 + 0))
  ...
  */
  def ImageDrawTextEx(dst : Ptr[Image], font : Font, text : CString, position : Vector2, fontSize : Float, spacing : Float, tint : Color)(using Zone): Unit = 
    ...
    !(__ptr_1 + 0) = position
    !(__ptr_0 + 0) = tint
    __sn_wrap_raylib_ImageDrawTextEx(dst, (__ptr_2 + 0), text, (__ptr_1 + 0), fontSize, spacing, (__ptr_0 + 0))
  ...
  */
  def ImageTextEx(font : Font, text : CString, fontSize : Float, spacing : Float, tint : Color)(using Zone): Image = 
    ...
    !(__ptr_1 + 0) = font
    !(__ptr_0 + 0) = tint
    __sn_wrap_raylib_ImageTextEx((__ptr_1 + 0), text, fontSize, spacing, (__ptr_0 + 0), (__ptr_2 + 0))
    !(__ptr_2 + 0)
  ...
  */
  def LoadFontFromImage(image : Image, key : Color, firstChar : CInt)(using Zone): Font = 
    ...
    !(__ptr_2 + 0) = image
    !(__ptr_0 + 0) = key
    __sn_wrap_raylib_LoadFontFromImage((__ptr_2 + 0), (__ptr_0 + 0), firstChar, (__ptr_1 + 0))
    !(__ptr_1 + 0)
  ...
  */
   ...
   * [bindgen] header: ./raylib/src/raymath.h
  */
  def MatrixFrustum(left : Double, right : Double, bottom : Double, top : Double, near : Double, far : Double)(__return : Ptr[Matrix]): Unit = 
    __sn_wrap_raylib_MatrixFrustum(left, right, bottom, top, near, far, __return)

  /**
   * [bindgen] header: ./raylib/src/raymath.h
  */
  def MatrixFrustum(left : Double, right : Double, bottom : Double, top : Double, near : Double, far : Double)(using Zone): Matrix = 
    val __ptr_0: Ptr[Matrix] = alloc[Matrix](1)
    __sn_wrap_raylib_MatrixFrustum(left, right, bottom, top, near, far, (__ptr_0 + 0))
    !(__ptr_0 + 0)
  ...
  */
  def MeasureTextEx(font : Font, text : CString, fontSize : Float, spacing : Float)(using Zone): Vector2 = 
    ...
    val __ptr_1: Ptr[Font] = alloc[Font](1)
    !(__ptr_1 + 0) = font
    __sn_wrap_raylib_MeasureTextEx((__ptr_1 + 0), text, fontSize, spacing, (__ptr_0 + 0))
    !(__ptr_0 + 0)
  ...
  */
  def QuaternionFromVector3ToVector3(from : Vector3, to : Vector3)(using Zone): Quaternion = 
    ...
    !(__ptr_0 + 0) = from
    !(__ptr_0 + 1) = to
    __sn_wrap_raylib_QuaternionFromVector3ToVector3((__ptr_0 + 0), (__ptr_0 + 1), (__ptr_1 + 0))
    !(__ptr_1 + 0)
  ...
  */
  def Vector3RotateByQuaternion(v : Vector3, q : Quaternion)(using Zone): Vector3 = 
    ...
    !(__ptr_0 + 0) = v
    !(__ptr_1 + 0) = q
    __sn_wrap_raylib_Vector3RotateByQuaternion((__ptr_0 + 0), (__ptr_1 + 0), (__ptr_0 + 1))
    !(__ptr_0 + 1)
