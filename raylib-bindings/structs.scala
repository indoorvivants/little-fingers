...
object AutomationEvent:
  given _tag: Tag[AutomationEvent] =
    Tag.materializeCStruct3Tag[CUnsignedInt, CUnsignedInt, CArray[CInt, Nat._4]]
...
object AutomationEventList:
  given _tag: Tag[AutomationEventList] =
    Tag.materializeCStruct3Tag[CUnsignedInt, CUnsignedInt, Ptr[AutomationEvent]]
...
object BoneInfo:
  given _tag: Tag[BoneInfo] =
    Tag.materializeCStruct2Tag[CArray[CChar, Nat.Digit2[Nat._3, Nat._2]], CInt]
  def apply()(using Zone): Ptr[BoneInfo] =
    scala.scalanative.unsafe.alloc[BoneInfo](1)
  def apply(name: CArray[CChar, Nat.Digit2[Nat._3, Nat._2]], parent: CInt)(using
      Zone
  ): Ptr[BoneInfo] =
    val ____ptr = apply()
    (!____ptr).name = name
...
object Font:
  given _tag: Tag[Font] =
    Tag.materializeCStruct6Tag[CInt, CInt, CInt, Texture2D, Ptr[Rectangle], Ptr[
      GlyphInfo
    ]]
...
object Material:
  given _tag: Tag[Material] =
    Tag.materializeCStruct3Tag[Shader, Ptr[MaterialMap], CArray[Float, Nat._4]]
...
/** [bindgen] header: ./raylib/src/raylib.h
  */
opaque type Model = CStruct9[Matrix, CInt, CInt, Ptr[Mesh], Ptr[Material], Ptr[
  CInt
], CInt, Ptr[BoneInfo], Ptr[Transform]]
object Model:
...
object ModelAnimation:
  given _tag: Tag[ModelAnimation] = Tag.materializeCStruct5Tag[CInt, CInt, Ptr[
    BoneInfo
  ], Ptr[Ptr[Transform]], CArray[CChar, Nat.Digit2[Nat._3, Nat._2]]]
...
object Music:
  given _tag: Tag[Music] = Tag
    .materializeCStruct5Tag[AudioStream, CUnsignedInt, Boolean, CInt, Ptr[Byte]]
...
object VrStereoConfig:
  ...
  extension (struct: VrStereoConfig)
    ...
    def rightScreenCenter_=(value: CArray[Float, Nat._2]): Unit = !struct.at6 =
      value
