...
private[raylib] trait _BindgenEnumCUnsignedInt[T](using eq: T =:= CUnsignedInt):
...
object BlendMode extends _BindgenEnumCUnsignedInt[BlendMode]:
...
object CameraMode extends _BindgenEnumCUnsignedInt[CameraMode]:
...
object CameraProjection extends _BindgenEnumCUnsignedInt[CameraProjection]:
...
object ConfigFlags extends _BindgenEnumCUnsignedInt[ConfigFlags]:
...
object CubemapLayout extends _BindgenEnumCUnsignedInt[CubemapLayout]:
...
object FontType extends _BindgenEnumCUnsignedInt[FontType]:
...
object GamepadAxis extends _BindgenEnumCUnsignedInt[GamepadAxis]:
...
object GamepadButton extends _BindgenEnumCUnsignedInt[GamepadButton]:
...
object Gesture extends _BindgenEnumCUnsignedInt[Gesture]:
...
object KeyboardKey extends _BindgenEnumCUnsignedInt[KeyboardKey]:
...
object MaterialMapIndex extends _BindgenEnumCUnsignedInt[MaterialMapIndex]:
...
object MouseButton extends _BindgenEnumCUnsignedInt[MouseButton]:
...
object MouseCursor extends _BindgenEnumCUnsignedInt[MouseCursor]:
...
object NPatchLayout extends _BindgenEnumCUnsignedInt[NPatchLayout]:
...
object PixelFormat extends _BindgenEnumCUnsignedInt[PixelFormat]:
...
object ShaderAttributeDataType extends _BindgenEnumCUnsignedInt[ShaderAttributeDataType]:
...
object ShaderLocationIndex extends _BindgenEnumCUnsignedInt[ShaderLocationIndex]:
  ...
  val SHADER_LOC_VERTEX_BONEIDS = define(26)
  val SHADER_LOC_VERTEX_BONEWEIGHTS = define(27)
  val SHADER_LOC_BONE_MATRICES = define(28)
  inline def getName(inline value: ShaderLocationIndex): Option[String] =
    inline value match
      ...
      case SHADER_LOC_VERTEX_BONEIDS => Some("SHADER_LOC_VERTEX_BONEIDS")
      case SHADER_LOC_VERTEX_BONEWEIGHTS => Some("SHADER_LOC_VERTEX_BONEWEIGHTS")
      case SHADER_LOC_BONE_MATRICES => Some("SHADER_LOC_BONE_MATRICES")
      case _ => _root_.scala.None
...
object ShaderUniformDataType extends _BindgenEnumCUnsignedInt[ShaderUniformDataType]:
...
object TextureFilter extends _BindgenEnumCUnsignedInt[TextureFilter]:
...
object TextureWrap extends _BindgenEnumCUnsignedInt[TextureWrap]:
...
object TraceLogLevel extends _BindgenEnumCUnsignedInt[TraceLogLevel]:
